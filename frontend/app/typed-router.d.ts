...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/asset-manager/more.vue': {
      routes: 'asset-manager-more' | 'asset-manager-counterparty-mapping' | 'asset-manager-cex-mapping' | 'asset-manager-newly-detected' | 'asset-manager-missing-mappings' | 'asset-manager-solana-token-migration' | '/asset-manager/more/cex-mapping' | '/asset-manager/more/counterparty-mapping' | '/asset-manager/more/missing-mappings' | '/asset-manager/more/newly-detected' | '/asset-manager/more/solana-token-migration'
      views: 'default'
    }
    ...
    'src/pages/settings.vue': {
      routes: '/settings' | '/settings/account/' | '/settings/accounting/' | '/settings/database/' | '/settings/general/' | '/settings/interface/' | '/settings/modules/' | '/settings/rpc/' | '/settings/oracle/' | '/settings/account' | '/settings/accounting' | '/settings/database' | '/settings/general' | '/settings/interface' | '/settings/modules' | '/settings/oracle' | '/settings/rpc'
      views: 'default'
    }
