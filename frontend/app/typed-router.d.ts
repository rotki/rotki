...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/settings.vue': {
      routes: '/settings' | '/settings/account/' | '/settings/database/' | '/settings/accounting/' | '/settings/general/' | '/settings/interface/' | '/settings/modules/' | '/settings/rpc/' | '/settings/oracle/' | '/settings/account' | '/settings/accounting' | '/settings/database' | '/settings/general' | '/settings/interface' | '/settings/modules' | '/settings/oracle' | '/settings/rpc'
      views: 'default'
    }
