...
declare module 'vue-router/auto-routes' {
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/settings.vue': {
      routes: '/settings' | '/settings/accounting/' | '/settings/account/' | '/settings/database/' | '/settings/general/' | '/settings/interface/' | '/settings/modules/' | '/settings/oracle/' | '/settings/rpc/' | '/settings/account' | '/settings/accounting' | '/settings/database' | '/settings/general' | '/settings/interface' | '/settings/modules' | '/settings/oracle' | '/settings/rpc'
      views: 'default'
    }
