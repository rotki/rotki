...
describe('useAccountingApi', () => {
  ...
  describe('fetchAccountingRules', () => {
    it('should send POST request and returns collection', async () => {
    ...
    it('should send all optional filter parameters', async () => {
      let capturedBody: unknown;
    ...
    it('should omit orderByAttributes and ascending from payload', async () => {
      let capturedBody: unknown;
  ...
  describe('fetchAccountingRule', () => {
    it('should send counterparties array with counterparty and null when counterparty is provided', async () => {
      let capturedBody: unknown;
    ...
    it('should send counterparties array with only null when counterparty is null', async () => {
      let capturedBody: unknown;
    ...
    it('should return matching counterparty when multiple entries exist', async () => {
      server.use(
  ...
  describe('addAccountingRule', () => {
    it('should send PUT request with rule data', async () => {
      let capturedBody: unknown;
  ...
  describe('editAccountingRule', () => {
    it('should send PATCH request with rule data including identifier', async () => {
      let capturedBody: unknown;
  ...
  describe('deleteAccountingRule', () => {
    it('should send DELETE request with identifier', async () => {
      let capturedBody: unknown;
  ...
  describe('getAccountingRuleLinkedMapping', () => {
    it('should send GET request and returns mapping', async () => {
      server.use(
  ...
  describe('fetchAccountingRuleConflicts', () => {
    it('should send POST request with pagination and returns conflicts collection', async () => {
      let capturedBody: unknown;
  ...
  describe('resolveAccountingRuleConflicts', () => {
    it('should send PATCH request with solveAllUsing resolution', async () => {
      let capturedBody: unknown;
    ...
    it('should send PATCH request with manual conflicts resolution', async () => {
      let capturedBody: unknown;
  ...
  describe('exportAccountingRules', () => {
    it('should send POST request with directoryPath and returns pending task', async () => {
      let capturedBody: unknown;
    ...
    it('should send POST request without directoryPath when undefined', async () => {
      let capturedBody: unknown;
  ...
  describe('uploadAccountingRulesData', () => {
    it('should send PATCH request with FormData containing file and async_query', async () => {
      ...
      expect(filepath).toBeInstanceOf(File);
      assert(filepath instanceof File, 'Expected filepath to be a File');
      expect(filepath.name).toBe('rules.json');
