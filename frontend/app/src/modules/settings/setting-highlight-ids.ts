...
export const SettingsHighlightIds = {
  ...
  AUTO_DETECT_TOKENS_ON_LOGIN: 'setting-auto-detect-tokens-on-login',
...
export const SettingsCategoryIds = {
  ...
  /** Querying and detection together, since both read as "skip this chain". Not {@link CHAINS}. */
