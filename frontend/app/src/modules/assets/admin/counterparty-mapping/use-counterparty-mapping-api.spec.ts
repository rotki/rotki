...
describe('useCounterpartyMappingApi', () => {
  ...
  describe('fetchAllCounterpartyMapping', () => {
    it('should send POST request with snake_case payload and returns collection', async () => {
  ...
  describe('addCounterpartyMapping', () => {
    it('should send PUT request with entries array', async () => {
      let capturedBody: unknown;
  ...
  describe('editCounterpartyMapping', () => {
    it('should send PATCH request with entries array', async () => {
      let capturedBody: unknown;
  ...
  describe('deleteCounterpartyMapping', () => {
    it('should send DELETE request with entries array in body', async () => {
      let capturedBody: unknown;
