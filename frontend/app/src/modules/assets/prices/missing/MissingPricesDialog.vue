...
/** Closes the form and re-prices only the resolved asset, which then drops off the list on its own. */
...
<template>
  <RuiDialog
    ...
    max-width="600"
  >
    <RuiCard data-testid="missing-prices-dialog">
      <template #header>
        {{ t('missing_prices_dialog.title') }}
      </template>

      <div class="text-body-2 text-rui-text-secondary mb-4">
        {{ t('missing_prices_dialog.description') }}
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            {{ t('missing_prices_dialog.add_price') }}
          </RuiButton>
        </div>
      </div>
      ...
      <template #footer>
        ...
        >
          ...
          >
            ...
            {{ t('missing_prices_dialog.open_manager') }}
          </RuiButton>
        </RouterLink>
        <div class="grow" />
        <RuiButton
