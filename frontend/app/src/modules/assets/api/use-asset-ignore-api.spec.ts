...
describe('useAssetIgnoreApi', () => {
  ...
  describe('getIgnoredAssets', () => {
    ...
    it('should return empty array when no assets are ignored', async () => {
      server.use(
        http.get(`${colibriUrl}/assets/ignored`, () =>
          HttpResponse.json({
            result: [],
  ...
  describe('addIgnoredAssets', () => {
    it('should send PUT request with assets array', async () => {
    ...
    it('should return noAction for already ignored assets', async () => {
      server.use(
  ...
  describe('removeIgnoredAssets', () => {
    it('should send DELETE request with assets array in body', async () => {
      let capturedBody: unknown;
    ...
    it('should return noAction for assets not in ignored list', async () => {
      server.use(
