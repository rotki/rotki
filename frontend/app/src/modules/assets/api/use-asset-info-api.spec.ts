...
vi.unmock('@/modules/assets/api/use-asset-info-api');
...
describe('composables/api/assets/info', () => {
  ...
  async function getApi(): Promise<ReturnType<typeof import('./use-asset-info-api').useAssetInfoApi>> {
    const { useAssetInfoApi } = await import('./use-asset-info-api');
