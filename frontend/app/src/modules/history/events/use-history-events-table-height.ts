 ...
 *
 * The regions passed in are the ones that change height while the page is open (action row, filter
 * chips). The virtual table needs a pixel offset rather than flex, so they are measured.
 *
