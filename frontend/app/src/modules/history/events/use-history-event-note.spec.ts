...
describe('useHistoryEventNotes', () => {
  ...
  it('should parse amount and asset', () => {
  ...
  it('should parse amount with different asset symbol', () => {
  ...
  it('should parse multi-word amount and asset', () => {
  ...
  it('should parse multiple ETH addresses', () => {
    const address = '0xCb2286d9471cc185281c4f763d34A962ED212962';
  ...
  it('should parse BTC or BCH addresses', () => {
  ...
  it('should parse Solana addresses', () => {
  ...
  describe('with Tx Ref', () => {
    ...
    it('should include tx reference when noTxRef is false', () => {
      const formatted = get(formatNotes({ notes }));
    ...
    it('should handle multiple tx hashes', () => {
    ...
    it('should exclude tx reference when noTxRef is true', () => {
  ...
  it('should parse validator index', () => {
  ...
  it('should parse multiple validator indices', () => {
    const validatorIndex = 201670;
  ...
  it('should parse source and target validator indices from extra data', () => {
  ...
  it('should parse multiple block numbers', () => {
    const blockNumber = 17173975;
  ...
  it('should scramble IBAN', async () => {
    store.updateFrontend({ scrambleData: false });
    ...
    store.updateFrontend({ scrambleData: true });
