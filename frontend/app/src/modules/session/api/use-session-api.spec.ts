      ...
      server.use(
        http.get(`${backendUrl}/api/1/messages`, () =>
          HttpResponse.json({
            result: {
              errors: [
                { type: 'user_message', data: { verbosity: 'error', value: 'Error 1', key: null, subject: null, fields: null } },
                { type: 'balance_snapshot_error', data: { location: 'kraken', error_message: 'oops' } },
              ],
              warnings: [
                { type: 'user_message', data: { verbosity: 'warning', value: 'Warning 1', key: null, subject: null, fields: null } },
              ],
            },
            message: '',
          })),
