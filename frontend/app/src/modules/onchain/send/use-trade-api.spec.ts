...
describe('useTradeApi', () => {
  ...
  describe('getIsInteractedBefore', () => {
    it('should send POST request and returns boolean result', async () => {
      let capturedBody: unknown;
    ...
    it('should return false when addresses never interacted', async () => {
      server.use(
  ...
  describe('getAssetBalance', () => {
    it('should send POST request and returns BigNumber', async () => {
      let capturedBody: unknown;
