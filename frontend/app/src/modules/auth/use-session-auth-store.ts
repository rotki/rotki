import type { IncompleteUpgradeConflict, SyncConflict } from '@/modules/auth/login';
import type { DataMigrationStatusData, DbUpgradeStatusData } from '@/modules/core/messaging/types';
