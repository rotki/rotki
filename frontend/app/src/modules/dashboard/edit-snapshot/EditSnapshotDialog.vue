...
import EditBalancesSnapshotTable from '@/modules/dashboard/edit-snapshot/EditBalancesSnapshotTable.vue';
import EditLocationDataSnapshotTable from '@/modules/dashboard/edit-snapshot/EditLocationDataSnapshotTable.vue';
import EditSnapshotTotal from '@/modules/dashboard/edit-snapshot/EditSnapshotTotal.vue';
