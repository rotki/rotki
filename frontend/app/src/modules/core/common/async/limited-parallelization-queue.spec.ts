...
describe('limited-parallelization-queue', () => {
  ...
  it('should run up to 5 tasks in parallel', async () => {
  ...
  it('should make new task with the same id pending', () => {
    queue.queue('1', async () => wait(1500));
  ...
  it('should replace pending task with the same id', async () => {
    queue.queue('1', async () => wait(1500));
    queue.queue('1', async () => wait(3000));
  ...
  it('should remove pending tasks from the queue on clear', () => {
    queue.queue('1', async () => wait(1500));
    queue.queue('1', async () => wait(3000));
