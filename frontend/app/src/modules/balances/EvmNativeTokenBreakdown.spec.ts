...
vi.mock('@/modules/core/common/use-supported-chains', async (): Promise<Record<string, unknown>> => {
...
vi.mock('@/modules/core/common/use-locations', (): Record<string, unknown> => ({
...
describe('evm-native-token-breakdown', () => {
  ...
  const createWrapper = (options: ComponentMountingOptions<typeof EvmNativeTokenBreakdown>): VueWrapper<InstanceType<typeof EvmNativeTokenBreakdown>> =>
