...
import { useCalendarReminderApi } from './use-calendar-reminder-api';
...
describe('useCalendarReminderApi', () => {
  ...
  describe('fetchCalendarReminders', () => {
    it('should send POST request with snake_case payload and returns entries', async () => {
  ...
  describe('deleteCalendarReminder', () => {
    it('should send DELETE request with identifier in body', async () => {
      let capturedBody: unknown;
