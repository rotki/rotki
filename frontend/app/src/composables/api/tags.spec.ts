...
describe('useTagsApi', () => {
  ...
  describe('queryTags', () => {
    it('should send GET request and returns tags record', async () => {
      server.use(
    ...
    it('should return empty record when no tags exist', async () => {
      server.use(
        http.get(`${backendUrl}/api/1/tags`, () =>
          HttpResponse.json({
            result: {},
  ...
  describe('queryDeleteTag', () => {
    it('should send DELETE request with name in body', async () => {
      let capturedBody: unknown;
    ...
    it('should return remaining tags after deletion', async () => {
      server.use(
