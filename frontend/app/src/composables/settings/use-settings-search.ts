...
import { type SettingsCategoryId, SettingsCategoryIds, type SettingsHighlightId, SettingsHighlightIds, type SettingsSearchEntry } from '@/composables/settings/types';
