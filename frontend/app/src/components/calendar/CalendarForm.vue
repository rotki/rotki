...
const description = useModelValueChild(modelValue, 'description');
const counterparty = useModelValueChild(modelValue, 'counterparty');
const color = useModelValueChild(modelValue, 'color');
const autoDelete = useModelValueChild(modelValue, 'autoDelete');
