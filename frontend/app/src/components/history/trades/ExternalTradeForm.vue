...
import { useBigNumberModel, useModelValueChild, useModelWithDefault } from '@/utils/model';
...
const base = useModelValueChild(modelValue, 'baseAsset');
const quote = useModelValueChild(modelValue, 'quoteAsset');
const amount = useModelValueChild(modelValue, 'amount');
const rate = useModelValueChild(modelValue, 'rate');
const fee = useModelValueChild(modelValue, 'fee');
const feeCurrency = useModelValueChild(modelValue, 'feeCurrency');
const link = useModelValueChild(modelValue, 'link');
const notes = useModelValueChild(modelValue, 'notes');
const type = useModelValueChild(modelValue, 'tradeType');
const timestamp = useModelValueChild(modelValue, 'timestamp');

const amountModel = useBigNumberModel(amount);
const feeModel = useBigNumberModel(fee);
const rateModel = useBigNumberModel(rate);

const notesModel = useModelWithDefault(notes);
const linkModel = useModelWithDefault(link);
const feeCurrencyModel = useModelWithDefault(feeCurrency);
