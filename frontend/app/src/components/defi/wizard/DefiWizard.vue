    ...
    <v-stepper v-model="step" vertical>
      ...
      <v-stepper-content step="1">
        <v-card class="mb-12" height="200px" outlined color="grey lighten-4">
          ...
          <v-card-text>
            ...
            <p>
              You can use the default settings if you want to have everything
              fetched automatically. (Defi Settings can changed at a later
              time).
            </p>
          </v-card-text>
        </v-card>
      ...
      <v-stepper-content step="2">
        <v-card outlined color="grey lighten-4" class="mb-12" height="300px">
          ...
          <v-card-subtitle>
            If no modules are specified then all modules will be activated
          </v-card-subtitle>
          <v-card-text>
            <v-row>
              <v-col>
