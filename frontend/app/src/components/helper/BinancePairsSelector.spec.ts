...
import { useExchangeApi, type UseExchangeApiReturn } from '@/composables/api/balances/exchanges';

vi.mock('@/composables/api/balances/exchanges', (): Record<string, unknown> => ({
