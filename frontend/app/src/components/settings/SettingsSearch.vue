...
import type { SettingsSearchEntry } from '@/composables/settings/types';
import { startPromise } from '@shared/utils';
import SettingsSearchItem from '@/components/settings/SettingsSearchItem.vue';
import { useSettingsHighlight } from '@/composables/settings/use-settings-highlight';
import { useSettingsSearch } from '@/composables/settings/use-settings-search';
