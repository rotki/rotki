...
import { useBigNumberModel, useModelValueChild } from '@/utils/model';
...
const label = useModelValueChild(modelValue, 'label');
const balanceType = useModelValueChild(modelValue, 'balanceType');
const location = useModelValueChild(modelValue, 'location');
const rawAmount = useModelValueChild(modelValue, 'amount');
