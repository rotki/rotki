...
import { useModelValueChild, useModelWithDefault } from '@/utils/model';
...
const customAssetType = useModelValueChild(modelValue, 'customAssetType');
const name = useModelValueChild(modelValue, 'name');
const notes = useModelWithDefault(useModelValueChild(modelValue, 'notes'));
