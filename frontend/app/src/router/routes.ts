export const Routes: Record<string, string> = {
  ...
  ACCOUNTS_BALANCES_BLOCKCHAIN: '/balances/blockchain',
  ACCOUNTS_BALANCES_BLOCKCHAIN_TAB: '/balances/blockchain/:tab*',
  ACCOUNTS_BALANCES_EXCHANGE: '/balances/exchange',
  ACCOUNTS_BALANCES_MANUAL: '/balances/manual',
  ACCOUNTS_BALANCES_NON_FUNGIBLE: '/balances/non-fungible',
  NFTS: '/nfts',
  HISTORY: '/history',
  ...
  API_KEYS_ROTKI_PREMIUM: '/settings/api-keys/premium',
  API_KEYS_EXCHANGES: '/settings/api-keys/exchanges',
  API_KEYS_EXTERNAL_SERVICES: '/settings/api-keys/external',
  IMPORT: '/import',
  SETTINGS: '/settings',
