...
function ask_permission(msg: string, username: string, password: string, create_true: any, api_key: string, api_secret: string) {
    $.confirm({
...
function unlock_user(username: string, password: string, create_true: any, sync_approval: any, api_key: string, api_secret: string) {
    $.alert({
        content: function() {
            let self = this;
...
function load_dashboard_after_unlock(exchanges: any, is_new_user: boolean) {
