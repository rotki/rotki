...
export class AssetTable {
    ...
    format_data(original_data: Array<any>): Array<any> {
        let data = [];
    ...
    populate(table_data: Array<any>, draw_cb: any): void {
        ...
        let init_obj = {
            ...
            'columns': [
                ...
                {'data': 'amount', 'title': 'Amount'},
                {
                    ...
                    'render': function (data: any , type: any, row: DataTables.RowMethodsModel) {
