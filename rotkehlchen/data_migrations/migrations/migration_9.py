...
def _reset_curve_decoded_events(write_cursor: 'DBCursor') -> None:
    ...
    """
    write_cursor.execute('SELECT DISTINCT tx_hash from evm_transactions LEFT JOIN history_events ON history_events.event_identifier=tx_hash WHERE counterparty IS ?', (CPT_CURVE,))  # noqa: E501
