...
from rotkehlchen.chain.linea.decoding.decoder import LineaTransactionDecoder
...
from rotkehlchen.chain.robinhood.decoding.decoder import RobinhoodTransactionDecoder
...
def get_decoded_events_of_transaction(
    ...
    chain_mappings = {
        ...
        ChainID.LINEA: (LineaTransactions, LineaTransactionDecoder),
