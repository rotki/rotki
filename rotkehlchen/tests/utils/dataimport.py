...
def assert_binance_purchases_import_results(rotki: Rotkehlchen):
    ...
    expected_trades = [
        Trade(
            ...
            trade_type=TradeType.BUY,
            amount=AssetAmount(FVal('374.69991101')),
            # rate=Price(FVal('0.74939982202')),
            rate=Price(FVal('1.334401170932373101873184776')),
            fee=Fee(FVal('10.00')),
            fee_currency=A_CAD,
            link='000000000000000000000000000000a0',
            notes='Debit Card Completed purchase',
        ),
        Trade(
            timestamp=Timestamp(1612051199),
            location=Location.BINANCE,
            ...
            quote_asset=symbol_to_asset_or_token('CAD'),
            trade_type=TradeType.BUY,
            amount=AssetAmount(FVal('1.55594')),
            # rate=Price(FVal('0.00155594')),
            rate=Price(FVal('642.6983045618725657801714719')),
            fee=Fee(FVal('20.00')),
            fee_currency=A_CAD,
            link='000000000000000000000000000000b1',
        ...
        Trade(
            ...
            quote_asset=symbol_to_asset_or_token('CAD'),
            trade_type=TradeType.BUY,
            amount=AssetAmount(FVal('0.00975')),
            # rate=Price(FVal('0.000039')),
            rate=Price(FVal('25641.02564102564102564102564')),
            fee=Fee(FVal('5.00')),
            fee_currency=A_CAD,
            link='000000000000000000000000000000c2',
            notes='Credit Card Completed purchase',
        ),
    ]
    assert trades == expected_trades
