...
def assert_cryptocom_import_results(rotki: Rotkehlchen):
    ...
    expected_events = [SwapEvent(
        ...
        identifier=36,
        event_identifier='CCM_87b1244732564cfaa122cb989c67c9f7d611463f7098fd4d4de00dd1a89ac763',
        ...
        identifier=38,
        event_identifier='CCM_8a618a6d3ce350415977c9bbf55661dde6614fbc47da5eb836c78c79ec3ddd7f',
...
def assert_binance_import_results(rotki: Rotkehlchen, websocket_connection: WebsocketReader):
    expected_events = [
        AssetMovement(
            ...
            event_identifier='BNC_a07a0997d480a1079f5935cb7d774dedf2e9f2761bfbb90e41e7d8a1b0e919dc',
            ...
            event_identifier='BNC_07f05dbef1c4ff56c8ad52fdf5dc0379380dcc67322f33a79be6545d53ebc562',
            timestamp=TimestampMS(1605903740000),
            location=Location.BINANCE,
            event_subtype=HistoryEventSubType.SPEND,
            asset=A_SOL,
            ...
            event_identifier='BNC_ba9b1f8e6e23a05dcc5755dd4bc5056d8b707fc3cc41cc7d140c7e6ee581efd2',
            ...
            event_identifier='BNC_4ccd4d5cb305cfdf798d75742393ea7ec22c897be73799bacd535783c2abaff3',
            ...
            event_identifier='BNC_2ccf1553641bd51089c3cb34403d8ba5839394640b43b1bec62be901be272115',
            timestamp=TimestampMS(1761762960000),
            location=Location.BINANCE,
            event_subtype=HistoryEventSubType.SPEND,
            asset=A_EUR,
            ...
            event_identifier='BNC_8500a93437be3948bce8d797fa8ffc5f9a84143e67d2de17b5fadb7e6507f41a',
            timestamp=TimestampMS(1761762960000),
            location=Location.BINANCE,
            event_subtype=HistoryEventSubType.SPEND,
            asset=A_EUR,
