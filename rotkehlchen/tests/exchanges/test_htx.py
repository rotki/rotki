...
def htx_account_mock(
    ...
    def _mock_authenticated_query(absolute_path: str, options: dict[str, Any] | None = None) -> dict[str, Any]:  # pylint: disable=unused-argument  # noqa: E501
        return next(iterators.get(absolute_path, iter([{}])))
