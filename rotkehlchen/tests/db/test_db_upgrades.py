...
def test_upgrade_db_47_to_48(user_data_dir, messages_aggregator):
    ...
    with db_v47.conn.read_ctx() as cursor:
        ...
        assert not table_exists(cursor, 'eth2_validator_data_cache')
    ...
    with db.conn.read_ctx() as cursor:
        ...
        assert table_exists(cursor, 'eth2_validator_data_cache')
...
def test_latest_upgrade_correctness(user_data_dir):
    ...
    assert new_tables == {'evm_transactions_authorizations', 'eth2_validator_data_cache'}
