...
def test_upgrade_db_47_to_48(user_data_dir, messages_aggregator):
    ...
    with db_v47.conn.read_ctx() as cursor:
        ...
        assert cursor.execute(
            ...
            (1749566127, 'A', 'ETH', 'USD', 'A', '10', '2732.36750009618', '12', 'USD', None, None),  # noqa: E501
            (1749566127, 'A', 'ETH', 'USD', 'A', '5', '2732.36750009618', None, None, '', ''),  # special test case although our code doesn't put empty strings in link, and they have no special meaning  # noqa: E501
