...
def fixture_temp_etherscan(function_scope_messages_aggregator, tmpdir_factory, sql_vm_instructions_cb, db_writer_port):  # noqa: E501
...
@pytest.mark.vcr(filter_query_parameters=['apikey'])
def test_etherscan_get_contract_abi(temp_etherscan: 'Etherscan') -> None:
    """Test the contract abi fetching from etherscan"""
    abi = temp_etherscan.get_contract_abi(ChainID.ETHEREUM, string_to_evm_address('0x5a464C28D19848f44199D003BeF5ecc87d090F87'))  # noqa: E501
    ...
    assert temp_etherscan.get_contract_abi(ChainID.ETHEREUM, string_to_evm_address('0x9531C059098e3d194fF87FebB587aB07B30B1306')) is None  # noqa: E501
