...
# def test_query_trade_history(rotkehlchen_server, function_scope_bittrex, function_scope_poloniex):  # noqa: E501
...
#     # only poloniex
#     with polo_patch:
#         result = rotkehlchen_server.query_trade_history('poloniex', start_ts=0, end_ts=TEST_END_TS)  # noqa: E501
...
#     # only bittrex
#     with bittrex_patch:
#         result = rotkehlchen_server.query_trade_history('bittrex', start_ts=0, end_ts=TEST_END_TS)  # noqa: E501
