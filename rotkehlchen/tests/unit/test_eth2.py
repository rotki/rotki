...
EXPECTED_DEPOSITS = [
    Eth2Deposit(
        ...
        tx_hash=hexstring_to_bytes('0xd9eca1c2a0c5ff2f25071713432b21cc4d0ff2e8963edc63a48478e395e08db1'),  # noqa: E501
        tx_index=15,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x3403bd94a1bf185ee18a525499e408a1b9b7d801cff6418e31efda346762e754'),  # noqa: E501
        tx_index=105,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x89b3b87c8841950893a4752ab03cbb835a1b5593a5d68cd343663824bf2d311e'),  # noqa: E501
        tx_index=57,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x1a228f3421f5b18904c92a21690b188d05a47bfbcfbe2175cbfdf27e2cd6ea53'),  # noqa: E501
        tx_index=25,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0xae84e32268d21ca03559d03abc769eaeaff2409ce282e7a1b9a3015a9cdb9357'),  # noqa: E501
        tx_index=26,
        timestamp=Timestamp(int(1604611182)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x7cb53c523001273ada3623edfdc32838683b3820589be2a450b1d527e8851070'),  # noqa: E501
        tx_index=27,
        timestamp=Timestamp(int(1604611182)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0xf2174fbaaf45204a178652ce28567d398a8afb3699b5bd34b5bbb7b33a3b8c34'),  # noqa: E501
        tx_index=28,
        timestamp=Timestamp(int(1604611182)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x187bef85f7797f4f42534fcfa080ed28ab77491b79fe9e9be8039416eebab6bc'),  # noqa: E501
        tx_index=29,
        timestamp=Timestamp(int(1604611182)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0xcb929eb5425743eb039edd03495a53141643f8e341483d7c8319d55a746a3e7d'),  # noqa: E501
        tx_index=178,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x64a66740ae4cf64e8735271f94fa9c763e9a68c506292671041301196f6f2d70'),  # noqa: E501
        tx_index=91,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0xccd2ddb9827a39bb30fd1a2166f40d2d571feab375e0d6469ba749d86e3f4e0b'),  # noqa: E501
        tx_index=190,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x721a69c5bd3b697827eabd44d7176e95ba803a462d99e74f62299111e8c516b1'),  # noqa: E501
        tx_index=198,
        timestamp=Timestamp(int(1604641801)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0xedf5930af6dd9efd54787d57acb250aff72ecb9a697b4abefa87274035343787'),  # noqa: E501
        tx_index=13,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x92f90a1271a184e1c5ee1e468f391bab5749108effb2c57a49f2cef153f9bc58'),  # noqa: E501
        tx_index=25,
        timestamp=Timestamp(int(1604641860)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x7c2f5f1ade5b7df58eebbe3c76b8cb038936e0f7fb4479ab5ac9df7a6f0fbd41'),  # noqa: E501
        tx_index=31,
        timestamp=Timestamp(int(1604641860)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x5722e35df3387aa21c825b0d8ddea3cf168d421a31edfe63c73ffc028df2a4f1'),  # noqa: E501
        tx_index=39,
        timestamp=Timestamp(int(1604641860)),
    ),
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0x6905f4d1843fb8c003c1fbbc2c8e6c5f9792f4f44ddb1122553412ee0b128da7'),  # noqa: E501
        tx_index=125,
    ...
    Eth2Deposit(
        ...
        value=Balance(FVal(32), FVal(64)),
        tx_hash=hexstring_to_bytes('0xc114753fb5d11a94a95dd980cff9f26693632550de56b5291201774686ddba3f'),  # noqa: E501
        tx_index=52,
