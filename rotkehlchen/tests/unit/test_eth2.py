...
from rotkehlchen.constants.timing import HOUR_IN_MILLISECONDS, HOUR_IN_SECONDS
...
def test_accumulating_validator_exit_pnl_with_multiple_deposits(
    ...
    It tries reproduces the issue where an accumulating validator (0x02 type) with:
