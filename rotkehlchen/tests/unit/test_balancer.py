...
TEST_SWAPS_TX_1 = [
    AMMSwap(
        ...
        log_index=254,
        address=string_to_evm_address('0x8e670b4d6651C4051e65B21AA4a575F3f99b8B83'),
        from_address=string_to_evm_address('0x65003947dC16956AfC4400008606001500940000'),
        to_address=string_to_evm_address('0x7860E28ebFB8Ae052Bfe279c07aC5d94c9cD2937'),
...
TEST_SWAPS_TX_2 = [
    ...
    AMMSwap(
        ...
        address=string_to_evm_address('0x8e670b4d6651C4051e65B21AA4a575F3f99b8B83'),
        from_address=string_to_evm_address('0x65003947dC16956AfC4400008606001500940000'),
        to_address=string_to_evm_address('0xa751A143f8fe0a108800Bfb915585E4255C2FE80'),
        timestamp=Timestamp(1614094145),
        location=Location.BALANCER,
        token0=A_AMPL,
        token1=A_WETH,
...
TEST_SWAPS_TX_3 = [
    AMMSwap(
        ...
        log_index=2,
        address=string_to_evm_address('0x029f388ac4d5c8bff490550ce0853221030e822b'),
        from_address=string_to_evm_address('0x0000000000007f150bd6f54c40a34d7c3d5e9f56'),
        to_address=string_to_evm_address('0x5a21e141ca90e46a2ee54f93b54a1bec608c307b'),
    ...
    AMMSwap(
        ...
        address=string_to_evm_address('0x029f388ac4d5c8bff490550ce0853221030e822b'),
        from_address=string_to_evm_address('0x0000000000007f150bd6f54c40a34d7c3d5e9f56'),
        to_address=string_to_evm_address('0x80cba5ba9259c08851d94d6bf45e248541fb3e86'),
        timestamp=Timestamp(1614150923),
        location=Location.BALANCER,
        token0=A_REN,
        token1=A_SNX,
    ...
    AMMSwap(
        ...
        address=string_to_evm_address('0x029f388ac4d5c8bff490550ce0853221030e822b'),
        from_address=string_to_evm_address('0x0000000000007f150bd6f54c40a34d7c3d5e9f56'),
        to_address=string_to_evm_address('0xe3f9cf7d44488715361581dd8b3a15379953eb4c'),
        timestamp=Timestamp(1614150923),
        location=Location.BALANCER,
        token0=A_SNX,
        token1=A_WETH,
