...
def test_hyperliquid(
    ...
    with GlobalDBHandler().conn.write_ctx() as write_cursor:
        write_cursor.executemany(
            'INSERT OR IGNORE INTO location_asset_mappings (location, exchange_symbol, local_id) VALUES (?, ?, ?)',  # noqa: E501
            [
                (Location.HYPERLIQUID.serialize_for_db(), 'HYPE', 'HYPE'),
                (Location.HYPERLIQUID.serialize_for_db(), 'USDC', arb_usdc.identifier),
            ],
