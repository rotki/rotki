...
def test_ens_lookup_multichain(
    ...
    result = ethereum_manager.ens_lookup(ENS_BRUNO, call_order)
    ...
    assert result == HexBytes(ENS_BRUNO_BTC_BYTES)
    ...
    assert result == HexBytes(ENS_BRUNO_SUBSTRATE_PUBLIC_KEY)
