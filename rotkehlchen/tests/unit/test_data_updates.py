...
from rotkehlchen.tests.api.test_location_asset_mappings import NUM_ASSETS_MAPPINGS_V1_37
...
def _check_location_asset_mappings(cursor: 'DBCursor', after_upgrade: bool) -> None:
    ...
    assert cursor.execute('SELECT COUNT(*) FROM location_asset_mappings').fetchone()[0] == NUM_ASSETS_MAPPINGS_V1_37  # noqa: E501
