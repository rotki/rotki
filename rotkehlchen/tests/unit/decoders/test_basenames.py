...
def test_basenames_register(
    ...
    assert events == [
        EvmEvent(
            ...
            asset=A_ETH,
            amount=FVal('0.000001963384627852'),
...
def test_basenames_register_with_discount(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            amount=FVal('0.000005269375874545'),
            location_label=user_address,
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
...
def test_basenames_set_attribute(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            amount=FVal('0.000000860174471941'),
            location_label=user_address,
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
...
def test_basenames_content_hash_changed(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            amount=FVal('0.000000178301347708'),
            location_label=user_address,
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
...
def test_basenames_new_owner(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            amount=FVal('0.000001274267527917'),
            location_label=user_address,
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
