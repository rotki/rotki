...
def test_kinetiq_partner_stake(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_HYPE,
            amount=FVal('0.0051277856259259'),
            location_label=hyperliquid_accounts[0],
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
...
def test_kinetiq_earn_deposit(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_HYPE,
            amount=FVal('0.000153270842071554'),
            location_label=hyperliquid_accounts[0],
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
...
def test_kinetiq_earn_withdraw_request(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_HYPE,
            amount=FVal('0.00016954769121696'),
            location_label=hyperliquid_accounts[0],
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
...
def test_kinetiq_earn_withdraw_solve(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_HYPE,
            amount=FVal('0.000752592441132494'),
            location_label=hyperliquid_accounts[0],
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_ref=tx_hash,
