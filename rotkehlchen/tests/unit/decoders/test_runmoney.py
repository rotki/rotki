...
def test_join_runmoney(base_inquirer: Any, base_accounts: Any) -> None:
...
@pytest.mark.parametrize('db_settings', LEGACY_TESTS_INDEXER_ORDER)
@pytest.mark.parametrize('base_accounts', [['0x533D5EcCdd097DE447E4142788dE58f341a4D619']])
def test_stake(base_inquirer: Any, base_accounts: Any) -> None:
...
def test_unstake(base_inquirer: Any, base_accounts: Any) -> None:
...
def test_claim_bonuses(base_inquirer: Any, base_accounts: Any) -> None:
