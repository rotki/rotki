...
def test_deposit_eth_from_ethereum_to_scroll(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:  # noqa: E501
...
def test_receive_eth_on_scroll(scroll_inquirer: Any, scroll_accounts: Any, allow_scroll_etherscan: Any) -> None:  # noqa: E501
...
def test_withdraw_eth_from_scroll_to_ethereum(scroll_inquirer: Any, scroll_accounts: Any, allow_scroll_etherscan: Any) -> None:  # noqa: E501
...
def test_receive_eth_on_ethereum(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_deposit_erc20_from_ethereum_to_scroll(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:  # noqa: E501
...
def test_receive_erc20_on_scroll(scroll_inquirer: Any, scroll_accounts: Any, allow_scroll_etherscan: Any) -> None:  # noqa: E501
...
def test_withdraw_erc20_from_scroll_to_ethereum(scroll_inquirer: Any, scroll_accounts: Any, caplog: Any, allow_scroll_etherscan: Any) -> None:  # noqa: E501
...
def test_withdraw_usdc_from_scroll_to_ethereum(scroll_inquirer: Any, scroll_accounts: Any, allow_scroll_etherscan: Any) -> None:  # noqa: E501
    """
    Test that USDC withdrawals from scroll to L1 work fine. This is just to test that
    our code is not token/gateway specific"""
    tx_hash = deserialize_evm_tx_hash('0xc21fbdc6b7a2051eb10a53a255ed55c11f776a053d4dbd72954120ebe0120307')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=scroll_inquirer, tx_hash=tx_hash)
...
def test_receive_erc20_on_ethereum(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_deposit_send_message_ethereum(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_receive_deposit_message_scroll(scroll_inquirer: Any, scroll_accounts: Any, allow_scroll_etherscan: Any) -> None:  # noqa: E501
