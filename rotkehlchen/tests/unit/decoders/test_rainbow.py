...
def test_rainbow_swap_eth_to_token(ethereum_inquirer, ethereum_accounts):
    ...
    timestamp = TimestampMS(1741808351000)
    swap_amount, received_amount, gas_fees, fee_amount = '0.2', '28827.267041421686554081', '0.000114360530468618', '0.00199745'  # noqa: E501
    expected_events = [EvmEvent(
        ...
        location_label=user_address,
        notes=f'Swap {swap_amount} ETH in Rainbow Swap',
        ...
        location_label=user_address,
        notes=f'Receive {received_amount} AIT as the result of a Rainbow Swap',
        counterparty=CPT_RAINBOW_SWAPS,
        address=RAINBOW_ROUTER_CONTRACT,
    ), EvmEvent(
        tx_hash=tx_hash,
        ...
        location_label=user_address,
        notes=f'Spend {fee_amount} ETH as Rainbow Swap fees',
        counterparty=CPT_RAINBOW_SWAPS,
        address=RAINBOW_ROUTER_CONTRACT,
    )]
...
def test_rainbow_swap_token_to_eth(ethereum_inquirer, ethereum_accounts):
    ...
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    user_address = ethereum_accounts[0]
    timestamp = TimestampMS(1741892171000)
    swap_amount, received_amount, gas_fees, fee_amount = '1010.887928111872496631', '0.089068967427375408', '0.000147805218572058', '0.00089852786738257'  # noqa: E501
    expected_events = [EvmEvent(
        tx_hash=tx_hash,
        sequence_index=0,
        timestamp=timestamp,
        ...
        amount=FVal(swap_amount),
        location_label=user_address,
        notes=f'Swap {swap_amount} BOOE in Rainbow Swap',
        address=RAINBOW_ROUTER_CONTRACT,
        counterparty=CPT_RAINBOW_SWAPS,
    ), EvmEvent(
        tx_hash=tx_hash,
        ...
        amount=FVal(received_amount),
        location_label=user_address,
        notes=f'Receive {received_amount} ETH as the result of a Rainbow Swap',
        address=RAINBOW_ROUTER_CONTRACT,
        counterparty=CPT_RAINBOW_SWAPS,
    ), EvmEvent(
        tx_hash=tx_hash,
...
def test_rainbow_swap_token_to_token(ethereum_inquirer, ethereum_accounts):
    ...
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    user_address = ethereum_accounts[0]
    timestamp = TimestampMS(1741889531000)
    gas_fees, swap_amount, received_amount, approve_amount, fee_amount = '0.000364910690805408', '77911.038010822816755701', '45110.517197738477939043', '115792089237316195423570985008687907853269984665640563961546.545997090312884234', '662.243823091993942423'  # noqa: E501
    expected_events = [EvmEvent(
        tx_hash=tx_hash,
        sequence_index=0,
        timestamp=timestamp,
        ...
        amount=FVal(swap_amount),
        location_label=user_address,
        notes=f'Swap {swap_amount} ZIG in Rainbow Swap',
        address=RAINBOW_ROUTER_CONTRACT,
        counterparty=CPT_RAINBOW_SWAPS,
    ), EvmEvent(
        tx_hash=tx_hash,
        ...
        amount=FVal(received_amount),
        location_label=user_address,
        notes=f'Receive {received_amount} AXGT as the result of a Rainbow Swap',
        counterparty=CPT_RAINBOW_SWAPS,
        address=RAINBOW_ROUTER_CONTRACT,
    ), EvmEvent(
        tx_hash=tx_hash,
        ...
        amount=FVal(fee_amount),
        location_label=user_address,
        notes=f'Spend {fee_amount} ZIG as Rainbow Swap fees',
        counterparty=CPT_RAINBOW_SWAPS,
        address=RAINBOW_ROUTER_CONTRACT,
    )]
