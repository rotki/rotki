...
def test_hop_l2_deposit(ethereum_inquirer: Any) -> None:
...
def test_hop_l2_deposit_usdc(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_hop_optimism_eth_receive(optimism_inquirer: Any) -> None:
    """Data taken from
...
def test_hop_optimism_eth_receive_no_event(optimism_inquirer: Any, optimism_accounts: Any) -> None:
    """Data taken from
...
def test_hop_usdc_bridge(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_hop_eth_bridge_optimism(optimism_inquirer: Any, optimism_accounts: Any) -> None:
...
def test_hop_eth_bridge_polygon_pos(polygon_pos_inquirer: PolygonPOSInquirer, polygon_pos_accounts: Any) -> None:  # noqa: E501
...
def test_hop_eth_bridge_base(base_inquirer: BaseInquirer, base_accounts: Any) -> None:
    events, _ = get_decoded_events_of_transaction(
...
def test_hop_eth_bridge_l2_to_l1_arbitrum_one(arbitrum_one_inquirer: ArbitrumOneInquirer, arbitrum_one_accounts: Any) -> None:  # noqa: E501
    events, _ = get_decoded_events_of_transaction(
...
def test_hop_eth_bridge_l2_to_l1_ethereum(ethereum_inquirer: EthereumInquirer, ethereum_accounts: Any) -> None:  # noqa: E501
...
def test_hop_magic_bridge_l2_to_l1_arbitrum_one(arbitrum_one_inquirer: ArbitrumOneInquirer, arbitrum_one_accounts: Any) -> None:  # noqa: E501
    events, _ = get_decoded_events_of_transaction(
        evm_inquirer=arbitrum_one_inquirer,
...
def test_hop_usdc_bridge_l2_to_l1_ethereum(ethereum_inquirer: EthereumInquirer, ethereum_accounts: Any) -> None:  # noqa: E501
...
def test_hop_eth_bridge_arbitrum_custom_recipient(arbitrum_one_inquirer: ArbitrumOneInquirer, arbitrum_one_accounts: Any) -> None:  # noqa: E501
    events, _ = get_decoded_events_of_transaction(
        evm_inquirer=arbitrum_one_inquirer,
...
@pytest.mark.vcr(filter_query_parameters=['apikey'])
@pytest.mark.parametrize('ethereum_accounts', [[ADDY]])
def test_vote_cast(ethereum_inquirer: Any) -> None:
