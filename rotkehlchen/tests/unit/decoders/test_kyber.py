...
def test_kyber_legacy_old_contract(database, ethereum_manager):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            notes='Burned 0.01212979988 ETH in gas from 0x6d379cb5BA04c09293b21Bf314E7aba3FfEAaF5b for transaction 0xe9cc9f27ef2a09fe23abc886a0a0f7ae19d9e2eb73663e1e41e07a3e0c011b87',  # noqa: E501
            counterparty='gas',
            identifier=None,
            extras=None,
        ), HistoryBaseEntry(
...
def test_kyber_legacy_new_contract(database, ethereum_manager):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            notes='Burned 0.066614401 ETH in gas from 0x5340F6faff9BF55F66C16Db6Bf9E020d987F87D0 for transaction 0xe80928d5e21f9628c047af1f8b191cbffbb6b8b9945adb502cfb3af152552f22',  # noqa: E501
            counterparty='gas',
            identifier=None,
            extras=None,
        ), HistoryBaseEntry(
