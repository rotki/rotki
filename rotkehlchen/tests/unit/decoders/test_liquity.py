...
def test_increase_liquity_staking(database, ethereum_manager, eth_transactions):
    """
    Data taken from
...
def test_remove_liquity_staking(database, ethereum_manager, eth_transactions):
    """
    Data taken from
