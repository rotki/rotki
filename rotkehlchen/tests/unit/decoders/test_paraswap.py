...
def test_simple_swap_token_fee(
        ethereum_inquirer: EthereumInquirer,
        ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
...
def test_swap_on_uniswap_v2_fork(
        ethereum_inquirer: EthereumInquirer,
        ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
...
def test_swap_on_uniswap_v2_fork_with_permit(
        ethereum_inquirer: EthereumInquirer,
        ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
...
def test_direct_uniswap_v3_swap(
        ethereum_inquirer: EthereumInquirer,
        ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
...
def test_direct_balancer_v2_given_swap(
        ethereum_inquirer: EthereumInquirer,
        ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
...
def test_simple_buy_fee_arbitrum_one(
...
def test_simple_swap_no_fee_base(
...
def test_direct_curve_v1_swap_optimism(
...
def test_direct_uniswap_v3_swap_polygon(
...
def test_paraswap_fork_with_factory(
        ethereum_inquirer: EthereumInquirer,
        ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
