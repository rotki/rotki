...
def test_omnibridge_ethereum_token_deposit(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_omnibridge_ethereum_eth_deposit(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_omnibridge_gnosis_token_deposit(gnosis_inquirer: Any, gnosis_accounts: Any, allow_gnosis_etherscan: Any) -> None:  # noqa: E501
...
def test_omnibridge_ethereum_token_withdrawal(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:  # noqa: E501
...
def test_omnibridge_ethereum_eth_withdrawal(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:  # noqa: E501
