...
def test_claim_and_withdraw(arbitrum_one_inquirer, arbitrum_one_accounts):
    ...
    assert events == [EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            balance=Balance(FVal(gas_str := '0.00000802845')),
            ...
            balance=Balance(FVal(lp_amount := '7.993230950234068615')),
            location_label=user_address,
            ...
            event_subtype=HistoryEventSubType.REWARD,
            asset=Asset('eip155:42161/erc20:0x040d1EdC9569d4Bab2D15287Dc5A4F10F56a56B8'),
            balance=Balance(FVal(amount := '137.462256109241289895')),
            location_label=user_address,
            ...
            event_subtype=HistoryEventSubType.REWARD,
            asset=Asset('eip155:42161/erc20:0x1509706a6c66CA549ff0cB464de88231DDBe213B'),
            balance=Balance(FVal(amount := '121.33328055412751574')),
            location_label=user_address,
            ...
            event_subtype=HistoryEventSubType.REWARD,
            asset=Asset('eip155:42161/erc20:0x1509706a6c66CA549ff0cB464de88231DDBe213B'),
            balance=Balance(FVal(amount := '169.472543006561768123')),
            location_label=user_address,
            notes=f'Claim {amount} AURA from Aura Finance',
            counterparty=CPT_AURA_FINANCE,
            ...
            balance=Balance(FVal(amount := '268.985898008824453673')),
            location_label=user_address,
            ...
            balance=Balance(FVal(amount := '21.084001')),
            location_label=user_address,
