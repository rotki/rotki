...
def test_sell_to_uniswap(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0xb9827174e182a1b8df3507d13c5cedccdc974c4edd5d66f59355f7e9758b9006',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '12.425145745058641',
        '646.553802069266414457',
        '0.018008266883477871',
    )
    expected_events = [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_sell_eth_for_token_to_uniswap_v3(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x5b7719016f7d7d3d8ed9d4d86afd0e0079551d0a7795f70f01764ce5eaa44478',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '0.2882978462709',
        '85192.182824334037015387',
        '0.007717607607009392',
    )
    expected_events = [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_sell_token_for_eth_to_uniswap_v3(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x68416e19252c678cdf67ae9b7adff742d78f95cea3c3f0582d3dc930340e5bdf',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '150000',
        '1.446309922122136822',
        '0.013066559749685724',
    )
    expected_events = [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_sell_token_for_token_to_uniswap_v3(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x6efe8a18de9ca3183bdb319be445f1b0b9041c0e8208fa04a58ee276b54574dd',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '26035459.499107021225491254',
        '6627.784156933620641174',
        '0.011785737692958302',
    )
    expected_events = [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_multiplex_batch_sell_eth_for_token(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0xa151bc4f1c69591598386eaa65761cefd706cbfe0a1a340d8856dbfe2c3bd8c5',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '1.160624381328078',
        '155577.466855002838240404',
        '0.0083327194970355',
    )
    expected_events = [
        EvmEvent(
...
def test_multiplex_batch_sell_token_for_eth(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0xf9b40a3bbbd92fe72099cff45564e099782fc9b0b4bd40c2d87484b43735b3b1',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '13438.664993496960137988',
        '2.669421884825430502',
        '0.01627396521423088',
    )
    expected_events = [
        EvmEvent(
...
def test_multiplex_batch_sell_token_for_token(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x0f422be6e6904700181c3effb0600a8ed7e1616e70e6587d383b29290d6a7c1d',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '125.156732374288853661',
        '43405.98545005',
        '0.018050672959219548',
    )
    expected_events = [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_multiplex_multihop_sell_token_for_token(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0xceccb105d312df00105eca2560b8da4cd0e791bb0f0da4cebeb17ca46abf2ce4',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '64666',
        '143469.489576604990799103',
        '0.03327224673453317',
    )
    expected_events = [
        EvmEvent(
...
def test_0x415565b0_eth_to_token(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    """Test ETH to Token swaps done through 0x415565b0 method ID via the 0x protocol router contract."""  # noqa: E501
    tx_hash = deserialize_evm_tx_hash(
        '0x56dd5341b27b744e3ef3a2f356a6db48cb811397495a4cb9e8924c8232ef9abc',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '2.9077036701035723',
        '688264582.664559041869620658',
        '0.016733414171811015',
    )
    expected_events = [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_execute_meta_transaction_v2(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    """Test meta transaction swaps done via the 0x protocol router contract."""
    tx_hash = deserialize_evm_tx_hash(
        '0xb77f8e36a86517928f890296a263cafafa48ef01c6cc424a838b59b4401bf314',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, meta_tx_fees = (
        '1405.596892',
        '4910.533168813496285354',
        '58.171192',
    )
    expected_events = [
        EvmSwapEvent(
...
def test_execute_meta_transaction_v2_multiplex(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    """Test meta transaction multiplex swaps done via the 0x protocol router contract."""
    tx_hash = deserialize_evm_tx_hash(
        '0x48f48d62b9829152c5963716acaed198320595859093cfc8a117742287f5a5eb',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, meta_tx_fees = (
        '49934.597014',
        '352963.071479518181477885',
        '65.402986',
    )
    expected_events = [
        EvmSwapEvent(
...
def test_execute_meta_transaction_v2_flash(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    """Test meta transaction swaps done via the 0x protocol using its flash contract."""
    tx_hash = deserialize_evm_tx_hash(
        '0xf0be288974b275768725e7322c66d4086bd9b70bac4427af394966d333c0c807',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, meta_tx_fees = (
        '10659.465069',
        '25162.301091908076364354',
        '60.028487',
    )
    expected_events = [
        EvmSwapEvent(
...
def test_swap_on_polygon_pos(
    ...
    events, _ = get_decoded_events_of_transaction(
        ...
        tx_hash=(
            tx_hash := deserialize_evm_tx_hash(
                '0x8e7c52d519d1ca0d1dfd8c8c21a2d2c34574e2bdada0ae7faafd49c1ddb8e8a6',
            )
        ),
    )
    swap_amount, received_amount, gas_fees = (
        '0.130848158787696777',
        '0.146129',
        '0.05669366828688572',
    )
    expected_events = [
...
def test_swap_on_binance_sc(
    ...
    tx_hash = deserialize_evm_tx_hash(
        '0xea3ec21b6e96e4972dbe734b10c417f451d5dc2b193aed37d5e9c28b4460a529',
    )
    events, _ = get_decoded_events_of_transaction(
...
def test_swap_arbitrum_one(
    ...
    events, _ = get_decoded_events_of_transaction(
        ...
        tx_hash=(
            tx_hash := deserialize_evm_tx_hash(
                '0x355c18ab70fb5d17098b6bc8fd527ce00f0b25c8220d6fe29522a1fb64b711bc',
            )
        ),
    )
    swap_amount, received_amount, meta_tx_fees = (
        '49920.273922',
        '11.88137754443033075',
        '79.726078',
    )
    expected_events = [
        EvmSwapEvent(
...
def test_swap_optimism(
    optimism_inquirer: OptimismInquirer,
    optimism_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x6b2b2d8c0cf2e27bb9e6c8309fd9887a066f9b72139acfe13d7ca5c29ae6c0ff',
    )
...
def test_swap_base(
    ...
    tx_hash = deserialize_evm_tx_hash(
        '0x4a5eb8fac7ef1d6637ff1d54e67791e4a5a49effb141f30e5af90f5aba5d48a5',
    )
...
def test_swap_on_pancakeswap(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0xcfb3b1587bb4d24a06d0f543493098ab285ae3763a489911da5bbea99bcb3499',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    swap_amount, received_amount, gas_fees = (
        '10.414111669423209',
        '36912.012249',
        '0.017837784148433769',
    )
    expected_events = [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_swap_on_curve(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x12d794e7ced93da02978aa9b46b59f27ceab49724fdb1b0c39963792af68fdf0',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
...
def test_swap_on_sushiswap(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x802f7d1c4b2f1b7ef48e5c3af92a3a166a91624b89e736f85b90df3dd7ce9d73',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
...
def test_swap_on_quickswap(
    ...
    events, _ = get_decoded_events_of_transaction(
        ...
        tx_hash=(
            tx_hash := deserialize_evm_tx_hash(
                '0x7b1bef89b8890e060787924a279e040ce8d50aedd35337747af6d56024ce269e',
            )
        ),
    )
    swap_amount, received_amount, gas_fees = (
        '58.6229436575138',
        '10313.421767180867447506',
        '0.05297558472',
    )
    expected_events = [
        EvmEvent(
...
def test_swap_optimism_with_return(
    optimism_inquirer: OptimismInquirer,
    optimism_accounts: list[ChecksumEvmAddress],
) -> None:
    ...
    """
    tx_hash = deserialize_evm_tx_hash(
        '0x0745615163e01c8a446f2520d5fa008dd69f308f24bcc3d2fec2466c1a2bc25c',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=optimism_inquirer, tx_hash=tx_hash)
    user_address, timestamp, gas_amount, swap_amount, received_amount = (
        optimism_accounts[0],
        TimestampMS(1706654255000),
        '0.000527795236079617',
        '1813.728944336150781643',
        '5820.310306',
    )
    assert events == [
        EvmEvent(
...
def test_swap_anon_event(
    ...
    """
    tx_hash = deserialize_evm_tx_hash(
        '0x5871cd5d19d749135ac563eddb4cb04bd0d13f05414666a887b1628f5968b7dc',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    assert events == [
        EvmSwapEvent(
...
def test_swap_settler_eth_token_ethereum(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    """
    ...
    """
    tx_hash = deserialize_evm_tx_hash(
        '0xd3e2b5dd91bcde440ef8d15dd01229562647be8cb07ae4dab48b80f6159e7f44',
    )
    ...
    assert events == [
        ...
        EvmSwapEvent(
            ...
            counterparty=CPT_ZEROX,
            address=string_to_evm_address('0x0d0E364aa7852291883C162B22D6D81f6355428F'),
        ),
        EvmSwapEvent(
            tx_ref=tx_hash,
            sequence_index=2,
...
def test_swap_settler_token_eth_ethereum(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    """
    ...
    """
    tx_hash = deserialize_evm_tx_hash(
        '0xcd135f41b57f72ece4939b376d33f09b84e88e4d576a0f87240d723a62e6ea93',
    )
    user_address, timestamp, asset, approval_recipient = (
        ethereum_accounts[0],
        TimestampMS(1742365487000),
        Asset('eip155:1/erc20:0x24fcFC492C1393274B6bcd568ac9e225BEc93584'),
        string_to_evm_address('0x000000000022D473030F116dDEE9F6B43aC78BA3'),
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    assert events == [
        EvmEvent(
        ...
        EvmEvent(
            ...
            amount=FVal(
                approval_amount
                := (
                    '115792089237316195423570985008687907853269984665640564039451.064165596108164711'
                ),
            ),
            location_label=user_address,
...
def test_swap_settler_token_token_ethereum(
    ethereum_inquirer: EthereumInquirer,
    ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    """
    ...
    """
    tx_hash = deserialize_evm_tx_hash(
        '0xd467dc8ddf753d1d49962ba84e42b369a8ab3de53cf45df84b56923747df11de',
    )
...
def test_swap_via_settler_on_arbitrum_one(
    arbitrum_one_inquirer: ArbitrumOneInquirer,
    arbitrum_one_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x4b83d2533c76e1840851e3fe7bd49eded1e3c40e81267850601850ab21afbf96',
    )
    events, _ = get_decoded_events_of_transaction(
        evm_inquirer=arbitrum_one_inquirer, tx_hash=tx_hash,
    )
    user_address, timestamp, gas_amount, swap_amount, received_amount, settler_address = (
        arbitrum_one_accounts[0],
        TimestampMS(1742464356000),
        '0.00000279049',
        '0.000324',
        '0.645954',
        string_to_evm_address('0xB254ee265261675528bdDb0796741c0C65a4C158'),
    )
    assert events == [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_swap_via_settler_on_base(
    base_inquirer: BaseInquirer,
    base_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0xdcb2ea00e5c31a2c6a9ac8cd507e07ff9a76c0b42652c5c550bee69f7425bea3',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=base_inquirer, tx_hash=tx_hash)
    user_address, timestamp, gas_amount, swap_amount, received_amount, settler_address = (
        base_accounts[0],
        TimestampMS(1742471249000),
        '0.000000540469180772',
        '0.00052',
        '1.026401',
        string_to_evm_address('0x5C9bdC801a600c006c388FC032dCb27355154cC9'),
    )
    assert events == [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_swap_via_settler_on_binance_sc(
    binance_sc_inquirer: BinanceSCInquirer,
    binance_sc_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x265b58104dba6237018416376611c1d0f170722b19c2949178127f6af496bac7',
    )
    events, _ = get_decoded_events_of_transaction(
        evm_inquirer=binance_sc_inquirer, tx_hash=tx_hash,
    )
    user_address, timestamp, gas_amount, swap_amount, received_amount, settler_address = (
        ...
        TimestampMS(1742451687000),
        '0.000168127',
        '1.156691259384',
        '904876.73552827873791536',
        string_to_evm_address('0x4C6F446dD88fD1be8B80D2940806002777dc12a2'),
    )
    assert events == [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_swap_via_settler_on_optimism(
    optimism_inquirer: OptimismInquirer,
    optimism_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x8b5e0f8a9fa216fad3687ec221c2044a7f6755f299e185e5655c762ce9689ddb',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=optimism_inquirer, tx_hash=tx_hash)
    user_address, timestamp, gas_amount, swap_amount, received_amount, settler_address = (
        optimism_accounts[0],
        TimestampMS(1742482043000),
        '0.000000261927407492',
        '0.00145',
        '3.213355834788683529',
        string_to_evm_address('0x402867B638339ad8Bec6e5373cfa95Da0b462c85'),
    )
    assert events == [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_swap_via_settler_on_polygon_pos(
    polygon_pos_inquirer: PolygonPOSInquirer,
    polygon_pos_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0xf09d96ecf300948b70c60ec1804202f4a30d20b4ee4de51a8a327c884e053f16',
    )
    events, _ = get_decoded_events_of_transaction(
        evm_inquirer=polygon_pos_inquirer, tx_hash=tx_hash,
    )
    user_address, timestamp, gas_amount, swap_amount, received_amount, settler_address = (
        polygon_pos_accounts[0],
        TimestampMS(1742477082000),
        '0.013230960026020888',
        '11.42',
        '2.42409',
        string_to_evm_address('0x7f20a7A526D1BAB092e3Be0733D96287E93cEf59'),
    )
    assert events == [
        EvmEvent(
            tx_ref=tx_hash,
...
def test_swap_via_another_settler_on_base(
    base_inquirer: BaseInquirer, base_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x78a911888adf24a8e321eb4f068e53d9562daad75ed2652e9fa5bb50a355f6e0',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=base_inquirer, tx_hash=tx_hash)
    assert events == [
        EvmEvent(
...
@pytest.mark.parametrize('db_settings', LEGACY_TESTS_INDEXER_ORDER)
@pytest.mark.parametrize('base_accounts', [['0x602CB34cE1B1d3133219D8a79c773fe9FAe3656e']])
def test_farcaster_zerox_swap(
    base_inquirer: BaseInquirer,
    base_accounts: list[ChecksumEvmAddress],
) -> None:
    """It uses a new version of the zerox settler contract"""
    tx_hash = deserialize_evm_tx_hash(
        '0x0f9229bfaeadac5c6e8b7f6525b8e713ac848149be2ee0d98ee19732879ec14d',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=base_inquirer, tx_hash=tx_hash)
...
def test_base_settler_zerox_swap(
    base_inquirer: BaseInquirer, base_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x304022641c44fd883a788e9fc962160a674f74835e1af4b13bc1afa882bcf17f',
    )
...
def test_zerox_regression_missing_settler(
    ethereum_inquirer: EthereumInquirer, ethereum_accounts: list[ChecksumEvmAddress],
) -> None:
    tx_hash = deserialize_evm_tx_hash(
        '0x5938e7bb41150365aa64e9dc5325febeeef698c216c39070d9e92bd7ffa66a9b',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    assert events == [
        EvmEvent(
...
@pytest.mark.parametrize('db_settings', LEGACY_TESTS_INDEXER_ORDER)
@pytest.mark.parametrize('base_accounts', [['0x2B888954421b424C5D3D9Ce9bB67c9bD47537d12']])
def test_base_settler_zerox_swap_runner_to_usdc(
    base_inquirer: BaseInquirer, base_accounts: list[ChecksumEvmAddress],
) -> None:
    ...
    tx_hash = deserialize_evm_tx_hash(
        '0x55cc5e692d0b50d335573f56c4347b806214973651887c82cb5b622e503ff4de',
    )
    events, _ = get_decoded_events_of_transaction(evm_inquirer=base_inquirer, tx_hash=tx_hash)
