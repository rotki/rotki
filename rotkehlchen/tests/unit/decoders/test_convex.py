...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0xC960338B529e0353F570f62093Fd362B8FB55f0B')]])  # noqa: E501
def test_booster_deposit(database, ethereum_manager, eth_transactions):
    ...
    user_address = string_to_ethereum_address('0xC960338B529e0353F570f62093Fd362B8FB55f0B')
    ...
    receipt = EthereumTxReceipt(
        ...
        logs=[
            EthereumTxReceiptLog(
                ...
                log_index=480,
                data=hexstring_to_bytes('0x0000000000000000000000000000000000000000000000003776765d951ea680'),  # noqa: E501
                address=string_to_ethereum_address('0xF403C135812408BFbE8713b5A23a04b3D48AAE31'),
                removed=False,
                topics=[
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0x53913A03a065f685097f8E8f40284D58016bB0F9')]])  # noqa: E501
def test_booster_withdraw(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0x53913A03a065f685097f8E8f40284D58016bB0F9')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
    ...
    receipt = EthereumTxReceipt(
        ...
        logs=[
            EthereumTxReceiptLog(
                ...
                address=string_to_ethereum_address('0xCB6D873f7BbE57584a9b08380901Dc200Be7CE74'),
                removed=False,
                topics=[
                    hexstring_to_bytes('0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'),  # noqa: E501
                ...
                address=string_to_ethereum_address('0xF3A43307DcAFa93275993862Aae628fCB50dC768'),
                removed=False,
                topics=[
                    hexstring_to_bytes('0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'),  # noqa: E501
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            asset=EthereumToken('0xCB6D873f7BbE57584a9b08380901Dc200Be7CE74'),
            ...
            event_subtype=HistoryEventSubType.NONE,
            asset=EthereumToken('0xF3A43307DcAFa93275993862Aae628fCB50dC768'),
            balance=Balance(amount=FVal('364.338089842514973505'), usd_value=ZERO),
            location_label='0x53913A03a065f685097f8E8f40284D58016bB0F9',
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0xFb305A40Dac406BdCF3b85F6311e5430770f44bA')]])  # noqa: E501
def test_cvxcrv_get_reward(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0xFb305A40Dac406BdCF3b85F6311e5430770f44bA')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=1655675488,
        block_number=14998088,
        from_address=user_address,
        to_address=string_to_ethereum_address('0x3Fe65692bfCD0e6CF84cB1E7d24108E434A7587e'),
        value=0,
        gas=171249,
    ...
    receipt = EthereumTxReceipt(
        ...
        logs=[
            EthereumTxReceiptLog(
                ...
                log_index=451,
                data=hexstring_to_bytes('0x00000000000000000000000000000000000000000000002eac6340ad673319bb'),  # noqa: E501
                address=string_to_ethereum_address('0x3Fe65692bfCD0e6CF84cB1E7d24108E434A7587e'),
                removed=False,
                topics=[
                ...
                log_index=453,
                data=hexstring_to_bytes('0x00000000000000000000000000000000000000000000001fd601592884f765d9'),  # noqa: E501
                address=string_to_ethereum_address('0x7091dbb7fcbA54569eF1387Ac89Eb2a5C9F6d2EA'),
                removed=False,
                topics=[
                    hexstring_to_bytes('0xe2403640ba68fed3a2f88b7557551d1993f84b99bb10ff833f0cf8db0c5e0486'),  # noqa: E501
                    hexstring_to_bytes('0x000000000000000000000000fb305a40dac406bdcf3b85f6311e5430770f44ba'),  # noqa: E501
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            event_type=HistoryEventType.RECEIVE,
            event_subtype=HistoryEventSubType.REWARD,
            asset=EthereumToken('0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490'),  # name='Curve.fi DAI/USDC/USDT', symbol='3Crv'  # noqa: E501
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0xe81FC42336c9314A9Be1EDB3F50eA9e275C93df3')]])  # noqa: E501
def test_cvxcrv_withdraw(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0xe81FC42336c9314A9Be1EDB3F50eA9e275C93df3')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
    ...
    receipt = EthereumTxReceipt(
        ...
        logs=[
            EthereumTxReceiptLog(
                ...
                log_index=423,
                data=hexstring_to_bytes('0x0000000000000000000000000000000000000000000003542cabeb617ec713f3'),  # noqa: E501
                address=string_to_ethereum_address('0x62B9c7356A2Dc64a1969e19C23e4f579F9810Aa7'),
                removed=False,
                topics=[
                    hexstring_to_bytes('0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'),  # noqa: E501
                    hexstring_to_bytes('0x0000000000000000000000003fe65692bfcd0e6cf84cb1e7d24108e434a7587e'),  # noqa: E501
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            event_type=HistoryEventType.WITHDRAWAL,
            event_subtype=HistoryEventSubType.NONE,
            asset=EthereumToken('0x62B9c7356A2Dc64a1969e19C23e4f579F9810Aa7'),
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0x2AcEcBF2Ee5BFc8eed599D58835EE9A7c45F3E2c')]])  # noqa: E501
def test_cvxcrv_stake(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0x2AcEcBF2Ee5BFc8eed599D58835EE9A7c45F3E2c')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0x5B186c93A50D3CB435fE2933427d36E6Dc688e4b')]])  # noqa: E501
def test_cvx_stake(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0x5B186c93A50D3CB435fE2933427d36E6Dc688e4b')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
        from_address=user_address,
        to_address=string_to_ethereum_address('0xCF50b810E57Ac33B91dCF525C6ddd9881B139332'),
        value=0,
        gas=0,
        gas_price=0,
        gas_used=0,
    ...
    receipt = EthereumTxReceipt(
        ...
        logs=[
            EthereumTxReceiptLog(
                ...
                address=A_CVX.ethereum_address,
                removed=False,
                topics=[
                    hexstring_to_bytes('0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'),  # noqa: E501
                ...
                log_index=344,
                data=hexstring_to_bytes('0x0000000000000000000000000000000000000000000000000de0b6b3a7640000'),  # noqa: E501
                address=string_to_ethereum_address('0xCF50b810E57Ac33B91dCF525C6ddd9881B139332'),
                removed=False,
                topics=[
                    hexstring_to_bytes('0x9e71bc8eea02a63969f509818f2dafb9254532904319f9dbda79b67bd34a5f3d'),  # noqa: E501
                    hexstring_to_bytes('0x0000000000000000000000005b186c93a50d3cb435fe2933427d36e6dc688e4b'),  # noqa: E501
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0x95c5582D781d507A084c9E5f885C77BabACf8EeA')]])  # noqa: E501
def test_cvx_get_reward(database, ethereum_manager, eth_transactions):
    ...
    expected_events = [
        HistoryBaseEntry(
            ...
            event_type=HistoryEventType.RECEIVE,
            event_subtype=HistoryEventSubType.REWARD,
            asset=EthereumToken('0x62B9c7356A2Dc64a1969e19C23e4f579F9810Aa7'),  # name='Convex CRV', symbol='cvxCRV'  # noqa: E501
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0x84BCE169c271e1c1777715bb0dd38Ad9e6381BAa')]])  # noqa: E501
def test_cvx_withdraw(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0x84BCE169c271e1c1777715bb0dd38Ad9e6381BAa')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0x999EcCEa3C4f9219B1B1B42b4830e62c26004B40')]])  # noqa: E501
def test_claimzap_abracadabras(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0x999EcCEa3C4f9219B1B1B42b4830e62c26004B40')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
        from_address=user_address,
        to_address=string_to_ethereum_address('0xDd49A93FDcae579AE50B4b9923325e9e335ec82B'),
        value=0,
        gas=0,
        gas_price=0,
        gas_used=0,
...
@pytest.mark.parametrize('ethereum_accounts', [[string_to_ethereum_address('0x0C3Cc503EaE928Ed6B5b01B8a9EE8de2855d03Ac')]])  # noqa: E501
def test_claimzap_cvx_locker(database, ethereum_manager, eth_transactions):
    ...
    evmhash = deserialize_evm_tx_hash(tx_hex)
    user_address = string_to_ethereum_address('0x0C3Cc503EaE928Ed6B5b01B8a9EE8de2855d03Ac')
    transaction = EthereumTransaction(
        tx_hash=evmhash,
        timestamp=0,
        block_number=0,
        from_address=user_address,
        to_address=string_to_ethereum_address('0xF403C135812408BFbE8713b5A23a04b3D48AAE31'),
        value=0,
        gas=0,
        gas_price=0,
        gas_used=0,
    ...
    receipt = EthereumTxReceipt(
        ...
        logs=[
            EthereumTxReceiptLog(
                ...
                log_index=307,
                data=hexstring_to_bytes('0x000000000000000000000000000000000000000000000009a1a464320783532c'),  # noqa: E501
                address=string_to_ethereum_address('0xD18140b4B819b895A3dba5442F959fA44994AF50'),
                removed=False,
                topics=[
