...
@pytest.mark.parametrize('load_global_caches', [[CPT_AERODROME]])
@pytest.mark.parametrize('base_accounts', [['0x514c4BA193c698100DdC998F17F24bDF59c7b6fB']])
def test_stake_lp_token_to_gauge(
        base_accounts: Any,
        base_transaction_decoder: Any,
...
def test_unlock_aero(base_accounts: Any, base_transaction_decoder: Any) -> None:
...
def test_lock_aero(base_accounts: Any, base_transaction_decoder: Any) -> None:
...
def test_increase_locked_amount(base_accounts: Any, base_transaction_decoder: Any) -> None:
...
def test_increase_unlock_time(base_accounts: Any, base_transaction_decoder: Any) -> None:
...
def test_vote(base_accounts: Any, base_transaction_decoder: Any) -> None:
...
@pytest.mark.parametrize('load_global_caches', [[CPT_AERODROME]])
@pytest.mark.parametrize('base_accounts', [['0x7264A62ae2f2BbE5Fe003F29108afB3C3dA0Bc16']])
def test_swap(base_transaction_decoder: Any, base_accounts: Any, load_global_caches: Any) -> None:
