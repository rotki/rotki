...
def test_increase_unlock_time(base_accounts, base_transaction_decoder):
    ...
    expected_events = [
        EvmEvent(
            ...
            counterparty=CPT_AERODROME,
            notes='Increase unlock time to 10/04/2025',
        ),
    ]
    assert events == expected_events
...
def test_vote(base_accounts, base_transaction_decoder):
    ...
    expected_events = [
        EvmEvent(
            ...
            counterparty=CPT_AERODROME,
            notes='Cast 1805.00657141664811293 votes for pool 0xDbdfAc0F9268EF02c34Ed58c9Fab3517a98444dc at 03/03/2025',  # noqa: E501
        ),
    ]
    assert events == expected_events
