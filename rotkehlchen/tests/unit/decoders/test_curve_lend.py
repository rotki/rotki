...
def test_vault_withdraw(
    ...
    assert events == [
        EvmEvent(
            ...
            balance=Balance(FVal(return_amount)),
            location_label=user_address,
            ...
            balance=Balance(FVal(withdraw_amount)),
            location_label=user_address,
...
def test_partially_repay_loan(
    ...
    assert events == [
        EvmEvent(
            ...
            asset=arbitrum_vault_underlying_token,
            balance=Balance(FVal(repay_amount)),
            location_label=user_address,
...
def test_close_loan_using_collateral(
    ...
    assert events == [
        EvmEvent(
            ...
            asset=arbitrum_vault_underlying_token,
            balance=Balance(FVal(receive1_amount)),
            location_label=user_address,
            ...
            event_subtype=HistoryEventSubType.REMOVE_ASSET,
            asset=A_WETH_ARB,
            balance=Balance(FVal(receive2_amount)),
            location_label=user_address,
