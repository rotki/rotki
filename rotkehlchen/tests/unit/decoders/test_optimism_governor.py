...
def test_vote_cast(optimism_inquirer: Any, optimism_accounts: Any) -> None:
...
@pytest.mark.parametrize('db_settings', LEGACY_TESTS_INDEXER_ORDER)
@pytest.mark.parametrize('optimism_accounts', [['0x2B888954421b424C5D3D9Ce9bB67c9bD47537d12']])
def test_vote_cast_with_params(optimism_inquirer: Any, optimism_accounts: Any) -> None:
    """Data is taken from
...
@pytest.mark.parametrize('db_settings', LEGACY_TESTS_INDEXER_ORDER)
@pytest.mark.parametrize('optimism_accounts', [['0x2B888954421b424C5D3D9Ce9bB67c9bD47537d12']])
def test_vote_cast_with_reason(optimism_inquirer: Any, optimism_accounts: Any) -> None:
