...
def test_blur_claim_and_stake(ethereum_inquirer: EthereumInquirer, ethereum_accounts: list[ChecksumEvmAddress]) -> None:  # noqa: E501
...
def test_blur_stake(ethereum_inquirer: EthereumInquirer, ethereum_accounts: list[ChecksumEvmAddress]) -> None:  # noqa: E501
...
def test_blur_unstake(ethereum_inquirer: EthereumInquirer, ethereum_accounts: list[ChecksumEvmAddress]) -> None:  # noqa: E501
