...
def test_curve_deposit_polygon(polygon_pos_inquirer, polygon_pos_accounts, load_global_caches):
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_POL,
            amount=FVal('0.0127938000149261'),
...
def test_gauge_deposit_optimism(database, optimism_inquirer, optimism_accounts, load_global_caches):  # noqa: E501
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            amount=FVal('0.000020026564634882'),
...
def test_gauge_withdraw_gnosis(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_XDAI,
            amount=FVal('0.000196106001764954'),
...
def test_curve_swap_router_base(base_inquirer, base_accounts):
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            amount=FVal('0.000001665983350053'),
...
def test_deposit_via_zap_arbitrum(arbitrum_one_inquirer, arbitrum_one_accounts, load_global_caches):  # noqa: E501
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.APPROVE,
            asset=arbitrum_usdt,
            amount=FVal('115792089237316195423570985008687907853269984665640564039457584007877854.731259'),
            location_label=arbitrum_one_accounts[0],
...
def test_curve_router_v1_2(base_inquirer: BaseInquirer, base_accounts: list[ChecksumEvmAddress]) -> None:  # noqa: E501
    ...
    assert events == [EvmEvent(
        ...
        event_subtype=HistoryEventSubType.FEE,
        asset=A_ETH,
        amount=(FVal('0.000006112533736574')),
...
def test_twocrypto_deposit(
    ...
    expected_events = [EvmEvent(
        ...
        event_subtype=HistoryEventSubType.FEE,
        asset=A_ETH,
        amount=FVal('0.00002088586348718'),
...
def test_twocrypto_removal(
    ...
    assert events == [EvmEvent(
        ...
        event_subtype=HistoryEventSubType.FEE,
        asset=A_ETH,
        amount=FVal('0.000006210240319768'),
        location_label=(user_address := ethereum_accounts[0]),
        counterparty=CPT_GAS,
    ), EvmEvent(
        tx_ref=tx_hash,
...
def test_tricrypto_deposit(
    ...
    expected_events = [EvmEvent(
        ...
        event_subtype=HistoryEventSubType.FEE,
        asset=A_ETH,
        amount=FVal('0.00011523890061032'),
        location_label=(user_address := ethereum_accounts[0]),
        counterparty=CPT_GAS,
    ), EvmEvent(
        tx_ref=tx_hash,
