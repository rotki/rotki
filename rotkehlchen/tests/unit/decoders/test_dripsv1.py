...
def test_project_collect_and_split(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_enduser_collect(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
@pytest.mark.vcr(filter_query_parameters=['apikey'])
@pytest.mark.parametrize('ethereum_accounts', [['0x9531C059098e3d194fF87FebB587aB07B30B1306']])
def test_splits_updated(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_give(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
def test_set_drips(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
