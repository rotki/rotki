...
def test_sushiswap_single_swap(ethereum_inquirer):
    ...
    expected_events = [
        EvmEvent(
            ...
            balance=Balance(amount=FVal(approved_amount)),
            location_label=ADDY_1,
...
def test_sushiswap_v2_remove_liquidity(ethereum_inquirer):
    ...
    expected_events = [
        EvmEvent(
            ...
            asset=A_ETH,
            balance=Balance(amount=FVal(removed_eth)),
            location_label=ADDY_2,
            ...
            balance=Balance(amount=FVal(spent_amount)),
            location_label=ADDY_2,
            ...
            event_subtype=HistoryEventSubType.REMOVE_ASSET,
            asset=A_USDT,
            balance=Balance(amount=FVal(removed_usdt)),
            location_label=ADDY_2,
...
def test_sushiswap_v2_add_liquidity(ethereum_inquirer):
    ...
    expected_events = [
        EvmEvent(
            ...
            asset=A_ETH,
            balance=Balance(amount=FVal(deposited_eth)),
            location_label=ADDY_3,
            ...
            event_subtype=HistoryEventSubType.DEPOSIT_ASSET,
            asset=A_USDT,
            balance=Balance(amount=FVal(deposited_usdt)),
            location_label=ADDY_3,
