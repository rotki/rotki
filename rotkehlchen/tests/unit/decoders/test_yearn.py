...
def test_deposit_yearn_v2_without_logs(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            balance=Balance(amount=FVal(0.001003537266292329)),
            location_label=user_address,
            notes='Burned 0.001003537266292329 ETH for gas',
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_hash=tx_hash,
            sequence_index=1,
            ...
            event_subtype=HistoryEventSubType.DEPOSIT_ASSET,
            asset=A_YFI,
            balance=Balance(amount=FVal('0.02192084')),
            location_label=user_address,
            ...
            balance=Balance(amount=FVal('0.02164738945170483')),
            location_label=user_address,
...
def test_withdraw_yearn_v2_without_logs(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            balance=Balance(amount=FVal(0.000631154785993836)),
            location_label=user_address,
            notes='Burned 0.000631154785993836 ETH for gas',
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_hash=tx_hash,
            sequence_index=1,
            ...
            balance=Balance(amount=FVal('86.244532826510255848')),
            location_label=user_address,
            ...
            balance=Balance(amount=FVal('92.236538270354905336')),
            location_label=user_address,
...
def test_deposit_yearn_v1(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            balance=Balance(amount=FVal(0.007502376)),
            location_label=user_address,
            notes='Burned 0.007502376 ETH for gas',
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_hash=tx_hash,
            sequence_index=1,
...
def test_withdraw_yearn_v1(
    ...
    assert events == [
        EvmEvent(
            ...
            event_subtype=HistoryEventSubType.FEE,
            asset=A_ETH,
            balance=Balance(amount=FVal(0.008944164419689952)),
            location_label=user_address,
            notes='Burned 0.008944164419689952 ETH for gas',
            counterparty=CPT_GAS,
        ), EvmEvent(
            tx_hash=tx_hash,
            sequence_index=1,
