...
def test_deposit_erc20(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
    """Data is taken from
    https://etherscan.io/tx/0x0297cc824348e477007dfea9b8a1e6a1ff9ddce3c4b35f170b4429bee5a8a00b
    """
    tx_hash = deserialize_evm_tx_hash('0x0297cc824348e477007dfea9b8a1e6a1ff9ddce3c4b35f170b4429bee5a8a00b')  # noqa: E501
...
def test_deposit_eth(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
    """Data is taken from
    https://etherscan.io/tx/0x4ccfa0fa8bf0a75030357c1ea0aa9040df4167785523e557beb640c00e039fb6
    """
    tx_hash = deserialize_evm_tx_hash('0x4ccfa0fa8bf0a75030357c1ea0aa9040df4167785523e557beb640c00e039fb6')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    user_address = ethereum_accounts[0]
    assert events == [
        EvmEvent(
...
def test_receive_erc20_on_optimism_legacy(optimism_inquirer: Any, optimism_accounts: Any) -> None:
    """Legacy bridge deposit to optimism. Where l1fee exists in receipt data"""
    tx_hash = deserialize_evm_tx_hash('0x1d47c8026bfc63ed0af553bd240430978cb43efba00864d597a747c90464074f')  # noqa: E501
...
def test_receive_erc20_on_optimism(optimism_inquirer: Any, optimism_accounts: Any) -> None:
    """Newer bridge deposit to optimism. Where l1fee is 0 and missing from receipt data"""
    tx_hash = deserialize_evm_tx_hash('0x0c0515e562917f86c8895765058df1d3df5aaf98aff00813c6f7d22c62a9b7d4')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=optimism_inquirer, tx_hash=tx_hash)
    user_address = optimism_accounts[0]
    assert events == [
        EvmEvent(
...
def test_receive_eth_on_optimism(optimism_inquirer: Any, optimism_accounts: Any) -> None:
...
def test_receive_eth_on_optimism_only_once(optimism_inquirer: Any, optimism_accounts: Any) -> None:
...
def test_withdraw_erc20(optimism_inquirer: Any, optimism_accounts: Any) -> None:
    """Data is taken from
    https://optimistic.etherscan.io/tx/0x5798c5d91658e6a3722f8507ca25ac9b21d7df555d364f5cd1f5578c92329412
    """
    tx_hash = deserialize_evm_tx_hash('0x5798c5d91658e6a3722f8507ca25ac9b21d7df555d364f5cd1f5578c92329412')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=optimism_inquirer, tx_hash=tx_hash)
    user_address = optimism_accounts[0]
    assert events == [
        EvmEvent(
...
def test_withdraw_eth(optimism_inquirer: Any, optimism_accounts: Any) -> None:
    """Data is taken from
    https://optimistic.etherscan.io/tx/0xe2111cddcd42c8214770c7a3270490c31663cd8b4b20b3fc27018ca3ce7a3979
    """
    tx_hash = deserialize_evm_tx_hash('0xe2111cddcd42c8214770c7a3270490c31663cd8b4b20b3fc27018ca3ce7a3979')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=optimism_inquirer, tx_hash=tx_hash)
    user_address = optimism_accounts[0]
    assert events == [
        EvmEvent(
...
def test_claim_erc20_on_ethereum(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
    """Data is taken from
    https://etherscan.io/tx/0xa577a47e439cc95d3f2b90f7c10a305c0c648c8f8b8a055872e622f341ab969e
    """
    tx_hash = deserialize_evm_tx_hash('0xa577a47e439cc95d3f2b90f7c10a305c0c648c8f8b8a055872e622f341ab969e')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    user_address = ethereum_accounts[0]
    assert events == [
        EvmEvent(
...
def test_claim_eth_on_ethereum(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
    """Data is taken from
    https://etherscan.io/tx/0x785df1d7f2cb08ba956792393a2d947f1c18b39bd924e238811e4a14da10b0c4
    """
    tx_hash = deserialize_evm_tx_hash('0x785df1d7f2cb08ba956792393a2d947f1c18b39bd924e238811e4a14da10b0c4')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=ethereum_inquirer, tx_hash=tx_hash)
    user_address = ethereum_accounts[0]
    assert events == [
        EvmEvent(
...
def test_prove_withdrawal(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:
...
@pytest.mark.parametrize('db_settings', LEGACY_TESTS_INDEXER_ORDER)
@pytest.mark.parametrize('optimism_accounts', [['0x9531C059098e3d194fF87FebB587aB07B30B1306']])
def test_deposit_dai_on_optimism(optimism_inquirer: Any, optimism_accounts: Any) -> None:
...
def test_withdraw_dai_on_optimism(optimism_inquirer: Any, optimism_accounts: Any) -> None:
...
def test_deposit_eth_ethereum_to_base_bridge(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:  # noqa: E501
...
def test_deposit_erc20_ethereum_to_base_bridge(ethereum_inquirer: Any, ethereum_accounts: Any) -> None:  # noqa: E501
...
def test_receive_eth_ethereum_to_base_bridge(base_inquirer: Any, base_accounts: Any) -> None:
...
def test_receive_eth_on_base_via_portal_deposit(base_inquirer: Any, base_accounts: Any) -> None:
...
def test_receive_eth_on_base_via_portal_deposit_to_other_address(base_inquirer: Any, base_accounts: Any) -> None:  # noqa: E501
...
def test_receive_erc20_ethereum_to_base_bridge(base_inquirer: Any, base_accounts: Any) -> None:
...
def test_withdraw_eth_base_to_ethereum_bridge(base_inquirer: Any, base_accounts: Any) -> None:
...
def test_withdraw_erc20_base_to_ethereum_bridge(base_inquirer: Any, base_accounts: Any) -> None:
