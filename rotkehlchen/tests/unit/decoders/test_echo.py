...
from rotkehlchen.chain.base.modules.echo.decoder import (
    FUNDING_CONDUIT
)
...
def test_echo_fund(base_inquirer, base_accounts):
    evmhash = deserialize_evm_tx_hash('0x6f16132d373dbba06259d04bd1e83771343c7ac17ac0a4e74fad645ed9d809de')  # noqa: E501
    ...
    assert events == [
        EvmEvent(
            ...
            notes=f'Set USDC spending approval of {base_accounts[0]} by {FUNDING_CONDUIT} to {fund_amount}',
        ...
        EvmEvent(
            ...
            notes=f'Paid 0 USDC as part of funding an Echo deal',
            address=FUNDING_CONDUIT
        ),
        EvmEvent(
            tx_hash=evmhash,
...
def test_echo_refund(base_inquirer, base_accounts):
    evmhash = deserialize_evm_tx_hash('0xfaeea0e01cecda7849efb3f27aa216c567366e10237b717a75587ff05ad7a7c6')  # noqa: E501
    events, _ = get_decoded_events_of_transaction(evm_inquirer=base_inquirer, tx_hash=evmhash)
    timestamp, deal_address = TimestampMS(1730227259000), string_to_evm_address('0x241F8222D1c80a4FDc25f9FC00181Eec770131A2')
    assert events == [
        EvmEvent(
            tx_hash=evmhash,
            sequence_index=492,
