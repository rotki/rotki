...
from rotkehlchen.tests.fixtures.exchanges.coinbase import *  # type: ignore
...
from rotkehlchen.tests.fixtures.history import *  # type: ignore
from rotkehlchen.tests.fixtures.messages import *  # type: ignore
