...
NUM_ASSETS_MAPPINGS_V1_34: Final = 1936
...
def test_location_asset_mappings_query(rotkehlchen_api_server: 'APIServer') -> None:
    ...
    assert len(result['entries']) == result['entries_found'] == result['entries_total'] == NUM_ASSETS_MAPPINGS_V1_34  # noqa: E501
    ...
    assert len(result['entries']) == result['entries_found'] == 41
    ...
    result = assert_proper_sync_response_with_result(response)
    assert len(result['entries']) == result['entries_found'] == 240
...
def test_location_asset_mappings_add(rotkehlchen_api_server: 'APIServer') -> None:
    ...
    assert len(all_mappings_after_addition) == result['entries_found'] == NUM_ASSETS_MAPPINGS_V1_34 + 2  # noqa: E501
...
def test_location_asset_mappings_delete(rotkehlchen_api_server: 'APIServer') -> None:
    ...
    assert len(all_mappings_after_deletion) == result['entries_found'] == NUM_ASSETS_MAPPINGS_V1_34 - 1  # noqa: E501
...
def test_location_asset_mappings_pagination(rotkehlchen_api_server: 'APIServer') -> None:
    ...
    assert result['entries_found'] == NUM_ASSETS_MAPPINGS_V1_34
