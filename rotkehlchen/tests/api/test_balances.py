...
def test_query_all_balances_ignore_cache(
    ...
    binance = cast('Binance', try_get_first_exchange(rotki.exchange_manager, Location.BINANCE))
    poloniex = cast('Poloniex', try_get_first_exchange(rotki.exchange_manager, Location.POLONIEX))
