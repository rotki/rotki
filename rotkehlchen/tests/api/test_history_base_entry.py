...
def _add_entries(server) -> List[HistoryBaseEntry]:
    entries = [HistoryBaseEntry(
        event_identifier=deserialize_evm_tx_hash('0x64f1982504ab714037467fdd45d3ecf5a6356361403fc97dd325101d8c038c4e'),  # noqa: 501
        sequence_index=162,
        ...
        event_identifier=deserialize_evm_tx_hash('0xf32e81dbaae8a763cad17bc96b77c7d9e8c59cc31ed4378b8109ce4b301adbbc'),  # noqa: 501
        sequence_index=2,
        ...
        event_identifier=deserialize_evm_tx_hash('0x4b5489ed325483db3a8c4831da1d5ac08fb9ab0fd8c570aa3657e0c267a7d023'),  # noqa: 501
        sequence_index=55,
