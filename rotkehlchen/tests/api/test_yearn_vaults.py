    ...
    expected_history = {
        'YALINK Vault': YearnVaultHistory(
            events=[YearnVaultEvent(
                ...
                from_asset=A_ALINK_V1.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('389.42925099069838547'), usd_value=ONE),
                to_asset=A_YV1_ALINK.resolve_to_crypto_asset(),
        ...
        'YCRV Vault': YearnVaultHistory(
            events=[YearnVaultEvent(
                ...
                from_asset=A_CRVP_DAIUSDCTTUSD.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('8927.5036'), usd_value=ONE),
                to_asset=A_YV1_DAIUSDCTTUSD.resolve_to_crypto_asset(),
                ...
                from_asset=A_YV1_DAIUSDCTTUSD.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('139761.8577'), usd_value=ONE),
                to_asset=A_CRVP_DAIUSDCTTUSD.resolve_to_crypto_asset(),
        ...
        'YSRENCURVE Vault': YearnVaultHistory(
            events=[YearnVaultEvent(
                ...
                from_asset=A_CRVP_RENWSBTC.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('19.555772781075598652'), usd_value=ONE),
                to_asset=A_YV1_RENWSBTC.resolve_to_crypto_asset(),
        ...
        'YUSDC Vault': YearnVaultHistory(
            events=[YearnVaultEvent(
                ...
                from_asset=A_USDC.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('24999.3143'), usd_value=ONE),
                to_asset=A_YV1_USDC.resolve_to_crypto_asset(),
                ...
                from_asset=A_YV1_USDC.resolve_to_crypto_asset(),
        ...
        'YUSDT Vault': YearnVaultHistory(
            events=[YearnVaultEvent(
                ...
                from_asset=A_USDT.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('7996.974556'), usd_value=ONE),
                to_asset=A_YV1_USDT.resolve_to_crypto_asset(),
                ...
                from_asset=A_YV1_USDT.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('7954.695816'), usd_value=ONE),
                to_asset=A_USDT.resolve_to_crypto_asset(),
        ...
        'YYFI Vault': YearnVaultHistory(
            events=[YearnVaultEvent(
                ...
                from_asset=A_YFI.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('5.06602125157175773'), usd_value=ONE),
                to_asset=A_YV1_YFI.resolve_to_crypto_asset(),
                ...
                from_asset=A_YV1_YFI.resolve_to_crypto_asset(),
                from_value=Balance(amount=FVal('5.064598986597546737'), usd_value=ONE),
                to_asset=A_YFI.resolve_to_crypto_asset(),
...
@pytest.mark.skipif(
    'CI' in os.environ,
    reason='Subgraph is broken at the moment',
)
@pytest.mark.parametrize('ethereum_accounts', [[TEST_V2_ACC2]])
@pytest.mark.parametrize('ethereum_modules', [['yearn_vaults_v2']])
@pytest.mark.parametrize('should_mock_current_price_queries', [True])
    ...
    expected_v2_history = {
        'eip155:1/erc20:0x1C6a9783F812b3Af3aBbf7de64c3cD7CC7D1af44': YearnVaultHistory(
            events=[YearnVaultEvent(
                ...
                from_asset=Asset(
                    'eip155:1/erc20:0x94e131324b6054c0D789b190b2dAC504e4361b53',
