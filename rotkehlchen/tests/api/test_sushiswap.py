...
def test_get_balances(
    ...
    assert wbtc_data['user_balance']['amount'] == '0.00431667'
    assert wbtc_data['user_balance']['value'] == '324.76035078'
    assert (weth_data := lp['assets'][1])['asset'] == 'eip155:1/erc20:0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'  # noqa: E501
    assert weth_data['user_balance']['amount'] == '0.128096459879448391'
    assert weth_data['user_balance']['value'] == '323.71768761974920683174'
    assert lp['user_balance']['amount'] == '0.000000008965605681'
    assert lp['user_balance']['value'] == '648.47803839974920683174'
