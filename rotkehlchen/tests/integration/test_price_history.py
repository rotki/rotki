...
def test_price_queries(price_historian: PriceHistorian, database: DBHandler) -> None:
    ...
    assert price_historian.query_historical_price(A_BTC, A_EUR, Timestamp(1479200704)) == FVal('664.837256889238')  # noqa: E501
    assert price_historian.query_historical_price(A_XMR, A_BTC, Timestamp(1579200704)) == FVal('0.00749129895207403')  # noqa: E501
    ...
    price_historian._cryptocompare = Cryptocompare(database=database)
    assert (oracles := price_historian._oracles) is not None
    price_historian.set_oracles_order(oracles)
    assert price_historian.query_historical_price(A_DASH, A_USD, Timestamp(1438387700)) == FVal('10')  # noqa: E501
    ...
    assert price_historian.query_historical_price(yusdt, A_USD, Timestamp(1704135600)) == expected_price  # noqa: E501
