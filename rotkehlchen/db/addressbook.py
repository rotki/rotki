...
class DBAddressbook:
    ...
    def get_addressbook_entries(
        ...
        query = 'SELECT COUNT(*) FROM address_book ' + query  # https://github.com/astral-sh/ruff/issues/10925 # noqa: E501 PLR6104
        ...
        query = 'SELECT address, name, blockchain FROM address_book ' + query  # https://github.com/astral-sh/ruff/issues/10925 # noqa: E501 PLR6104
