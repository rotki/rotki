...
from typing import Any, AsyncGenerator, ContextManager, Generator, Optional
...
class AsyncDBConnection:
    ...
    async def execute(self, query: str, *args) -> Optional[list[Any]]:
...
class AsyncDBCursor:
    ...
    async def execute(self, query: str, params: Optional[tuple] = None) -> 'AsyncDBCursor':
        """Execute a query"""
