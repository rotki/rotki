...
# Created at 2025-11-15 10:35:17 UTC with rotki version 1.41.dev18376+g8abcfe9 by Mandros7
MINIMIZED_USER_DB_SCHEMA = {
    ...
    "lido_csm_node_operators": "node_operator_idintegernotnullprimarykey,addresstextnotnull",
    "lido_csm_node_operator_metrics": "node_operator_idintegernotnullprimarykey,operator_type_idinteger,bond_currenttext,bond_requiredtext,bond_claimabletext,total_deposited_keysinteger,rewards_pendingtext,updated_tsinteger,foreignkey(node_operator_id)referenceslido_csm_node_operators(node_operator_id)onupdatecascadeondeletecascade",
}
