...
# Created at 2026-01-14 17:07:11 UTC with rotki version 1.41.4.dev286+g988bb52767 by prettyirrelevant
MINIMIZED_USER_DB_SCHEMA = {
    ...
    "event_metrics": "idintegernotnullprimarykey,event_identifierintegernotnullreferenceshistory_events(identifier)ondeletecascade,location_labeltext,protocoltext,metric_keytextnotnull,metric_valuetextnotnull,unique(event_identifier,location_label,protocol,metric_key)",
}
