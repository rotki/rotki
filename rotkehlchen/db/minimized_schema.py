...
# Created at 2026-01-27 16:53:37 UTC with rotki version 1.41.2.dev577+g3a0007d9b8 by lefteris
MINIMIZED_USER_DB_SCHEMA = {
    ...
    "event_metrics": "idintegernotnullprimarykey,event_identifierintegernotnullreferenceshistory_events(identifier)ondeletecascade,location_labeltext,protocoltext,metric_keytextnotnull,metric_valuetextnotnull,assettextnotnull,unique(event_identifier,location_label,protocol,metric_key,asset)",
}
...
MINIMIZED_USER_DB_INDEXES = {
    ...
    "idx_event_metrics_metric_key_bucket": "createindexifnotexistsidx_event_metrics_metric_key_bucketonevent_metrics(metric_key,location_label,protocol,asset)",
    "idx_event_metrics_metric_key_event": "createindexifnotexistsidx_event_metrics_metric_key_eventonevent_metrics(metric_key,event_identifier)",
