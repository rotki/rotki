...
# Created at 2025-05-03 17:08:05 UTC with rotki version 1.38.2.dev234+g091a41aee by yabir
MINIMIZED_USER_DB_SCHEMA = {
    ...
    "evmtx_topics_index": "topic_idintegerprimarykey,topic_valueblobuniquenotnull",
    "evmtx_receipt_log_topics": "logintegernotnull,topic_idintegernotnull,topic_indexintegernotnull,foreignkey(log)referencesevmtx_receipt_logs(identifier)ondeletecascadeonupdatecascade,foreignkey(topic_id)referencesevmtx_topics_index(topic_id)ondeleterestrictonupdatecascade,--userestricttopreventdeletingatopicthat'sstillusedprimarykey(log,topic_index)",
