...
LOCATION_DETAILS = {
    Location.EXTERNAL: LocationDetails(icon='book-2-line'),
    ...
    Location.BANKS: LocationDetails(icon='bank-line'),
    Location.BLOCKCHAIN: LocationDetails(icon='link'),
    Location.COINBASEPRO: LocationDetails(
        image='coinbasepro.svg',
        label='Coinbase Pro',
    ),
    Location.GEMINI: LocationDetails(image='gemini.svg'),
    Location.EQUITIES: LocationDetails(icon='suitcase-2-line'),
    Location.REALESTATE: LocationDetails(icon='home-3-line'),
    Location.COMMODITIES: LocationDetails(icon='leaf-line'),
