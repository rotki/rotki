...
class ExchangeWithoutApiSecret(CacheableMixIn, LockableQueryMixIn):
    ...
    def add_classified_warning(self, msg: str, classification: MessageClassification) -> None:
        """The warning counterpart of add_classified_error, with the same subject."""
        self.msg_aggregator.add_warning(msg, classification=classification, subject=self.location)
