...
LOCATION_DETAILS = {
    ...
    Location.COINBASEPRO: LocationDetails(image='coinbasepro.svg'),
    ...
    Location.BINANCEUS: LocationDetails(image='binance.svg'),
    ...
    Location.INDEPENDENTRESERVE: LocationDetails(image='independentreserve.svg'),
    ...
    Location.FTXUS: LocationDetails(image='ftxus.svg'),
