...
from .constants import AAVE_TREASURY, BORROW, BURN, DEPOSIT, ETH_GATEWAYS, POOL_ADDRESS, REPAY
...
class Aavev3Decoder(Commonv2v3Decoder):
    def __init__(
            self,
    ...
    def decode_liquidation(
        ...
        for event in context.decoded_events:
            ...
            elif event.address == AAVE_TREASURY:  # fee
