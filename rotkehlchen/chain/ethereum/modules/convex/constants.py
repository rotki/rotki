...
CONVEX_POOLS = {  # mapping of pool rewards address: pool name
    ...
    string_to_evm_address('0x27FB53CDA31de0BFc634086e180EE8c5f44a28Eb'): 'sdFXSlp-f',
    string_to_evm_address('0x26cE86C54f779ea79be855b3B99201fe4dCf0c5b'): 'ALDETH-f',
    string_to_evm_address('0x3e966Aec2a7b31F237e0E1C394a254C500DFb07B'): 'JPEGETH-f',
    string_to_evm_address('0xB94c129Cb0Adf7f5928e07476c668998251685F2'): 'sdYFIpool-f',
    string_to_evm_address('0x16aA741b46180bdCB83faFb65965B0A94D5a918C'): 'yCRV-f',
    string_to_evm_address('0x21E2d7f66DF6F4e8199210b9490a51831C9847C7'): 'crvUSDCWETHINV',
    string_to_evm_address('0xf011aD8E91D1dc8625e5548755AEa1F6Fff81089'): 'rETHfrxETH-f',
    string_to_evm_address('0xe0DbbCF08A5465db7c7401C86cce89030e11aB67'): 'alfrxETH-f',
    string_to_evm_address('0xD22c1Dc9baEb5b549401Dd42E6227953cd816776'): 'sdCRVlp-f',
    string_to_evm_address('0x9f6277061ec97A8fE5a1672bde4fc6b12dBb5DD6'): 'ETHxWETH-f',
    string_to_evm_address('0x6cD1a734F3d49Cc5b381c2b53CF17f12bfFA2bdD'): 'ETHwBETHCRV',
    string_to_evm_address('0xb3113f4dA77EA0Ec93Fb2aa0272c1aB73bf4F0B0'): 'crvUSDMIM-f',
    string_to_evm_address('0x6991C1CD588c4e6f6f1de3A0bac5B8BbAb7aAF6d'): 'crvfraxUSDP',
    string_to_evm_address('0xD24e00740306A67e29F189B55343F4804683d231'): 'sdPENDLElp-f',
    string_to_evm_address('0x15b7011bDE1C5836C67f16E6e03033c272156193'): 'ETH+ETH-f',
    string_to_evm_address('0x0106Bff3bD9C3BB9e4F8776591288F6855c4aF95'): 'dETHfrxETH-f',
    string_to_evm_address('0x6B27D7BC63F1999D14fF9bA900069ee516669ee8'): 'stETH-ng-f',
    string_to_evm_address('0x55cdF6c7E6d04b83835E4702ed395D0263237DA2'): 's-frxETH-f',
    string_to_evm_address('0x84754821b5484A69DB3164eF4eDC5A5657318039'): 'rETHfrxETH-f',
    string_to_evm_address('0x24b65DC1cf053A8D96872c323d29e86ec43eB33A'): 'OETHCRV-f',
    string_to_evm_address('0x98B662443695f7328F6A7fDe9894CC0E88630269'): 'z-frxETH-f-f',
    string_to_evm_address('0x19F3C877eA278e61fE1304770dbE5D78521792D2'): 'cvxfxs-fxs-f',
    string_to_evm_address('0x0080d49D4a4921dF0F3853c5e4533462A51fbb29'): 'cbETHfrxET-f',
    string_to_evm_address('0x442E773FFB0043551417D5A37E10c17990fB075c'): 'msETHWETH-f',
    string_to_evm_address('0xAE0b6b66378C7DEFc0514D7cBc6E4e92Cf56b0af'): 'COILFRAX-f',
    string_to_evm_address('0xA064C1EeEbECD1DF41432f4B7264F508F005aF0C'): 'frxETHCVX-f',
    string_to_evm_address('0x1C47c8fCE85018AA6645b5aE39c4c61D708CB3f9'): 'WACMEFRXET-f',
    string_to_evm_address('0x91362eBf6DbFA5c0FD45CE4cF46DfFd4A8899c7C'): 'swETHfxETH-f',
    string_to_evm_address('0xbe99C9A460488Ef88eF46db02a1222563acAd636'): 'crvUSDSUSD-f',
    string_to_evm_address('0x80c64E468b774F7F96D4DFCe39caE2dd4C2B7f93'): 'crvUSDUSDP-f',
    string_to_evm_address('0x6EeFB42b64C4Fa4558D7e9e9163246468e45F623'): 'crvUSDUZD-f',
    string_to_evm_address('0xdEC6Ad921212d9eFe9643DDBfc1A1F1d4731060d'): 'crvCRVUSDTBTCWSTETH',
    string_to_evm_address('0xb05262D4aaAA38D0Af4AaB244D446ebDb5afd4A7'): 'crvUSDTWBTCWETH',
    string_to_evm_address('0xC25d31c9DFBa32e3609233291772CACB30303338'): 'crvUSDGHO-f',
    string_to_evm_address('0xC94208D230EEdC4cDC4F80141E21aA485A515660'): 'crvUSDDOLA-f',
    string_to_evm_address('0xb64D8A89D6C3475D7E402Fa2Ce175dcf557481D1'): 'pUSDFRAXBP3CRV-f',
    string_to_evm_address('0x12261736A428580D53dfb2F213ae389e251Be4CF'): 'sdANGLElp-f',
    string_to_evm_address('0xF956a46DbA1A0a567168db8655bc18E9050C7738'): 'crvUSDETHCRV',
    string_to_evm_address('0xD1DdB0a0815fD28932fBb194C84003683AF8a824'): 'crvUSDUSDT-f',
    string_to_evm_address('0x3CfB4B26dc96B124D15A6f360503d028cF2a3c00'): 'crvUSDFRAX-f',
    string_to_evm_address('0x57f4cf13b325Ad101CfE9AD3a84d3B2302AA96c8'): 'crvUSDCWBTCWETH',
    string_to_evm_address('0xd5dC65ec6948845C1C428fb60BE38FE59B50BD13'): 'CRVfrxETH-f',
    string_to_evm_address('0xC4581E043F676b95Eb1430474C69f3559a758086'): 'GRAIFRAXBP3CRV-f',
    string_to_evm_address('0xC3D0B8170E105d6476fE407934492930CAc3BDAC'): 'st-frxETH-f',
    string_to_evm_address('0xA3D3D65101C99f7Dc8dd2D4f15E256341c8E40de'): 'DCHF3CRV-f',
    string_to_evm_address('0x60E4001E9D96618655C9e59Cdf5e9db40076b8e0'): 'agEUR-VEUR-f',
    string_to_evm_address('0x245Ec0d447e7f206B43120Ac292dED5E8bB9fe61'): 'hyUSDeUSD-f',
    string_to_evm_address('0xc18695D5824C49cF50E054953B3A5910c45597A0'): 'ankrfrxETH-f',
    string_to_evm_address('0x44D8FaB7CD8b7877D5F79974c2F501aF6E65AbBA'): 'crvUSDUSDC-f',
    string_to_evm_address('0xeF9555dCFa2E9014B416833C6FDEa09db1d6B17F'): 'pETHfrxETH-f',
    string_to_evm_address('0x6c3b5c66747645719726e232Ea005758f7817376'): 'VCHFFRAXBP-f',
    string_to_evm_address('0xFd3A7636694259b32B3896f59436997AD25380cA'): 'ZUSDFBP3CRV-f',
    string_to_evm_address('0xf8Fa0b3899DE5B4b3cb0cfF65b528AcDD2d163F3'): 'STBT3CRV-f',
    string_to_evm_address('0x15507737f44446EB0A86147E2C72Aa6A111A64B2'): 'msfrxETH-f',
    string_to_evm_address('0xA9717e6EA61075D4767708F28aB08D0Ae630bC7d'): 'DUSDFRAXBP3CRV-f',
    string_to_evm_address('0x3d55c3109cd2b5707E7C237f8bB15e0ec4b7CafB'): 'crvUSDGUSD-f',
    string_to_evm_address('0x4e2637D6697ed953241D44E29Fba55748F651861'): 'crvUSDTUSD-f',
    string_to_evm_address('0x4F9a0f637B33B0D35135cda5782797617afef00e'): 'eCFXETH-f',
}
