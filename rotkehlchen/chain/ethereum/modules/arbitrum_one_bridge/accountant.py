...
class ArbitrumOneBridgeAccountant(ModuleAccountantInterface):
    ...
    def event_settings(self, pot: 'AccountingPot') -> dict[str, TxEventSettings]:  # pylint: disable=unused-argument  # noqa: E501
        ...
        return {
            get_tx_event_type_identifier(HistoryEventType.DEPOSIT, HistoryEventSubType.BRIDGE, CPT_ARBITRUM_ONE): TxEventSettings(  # noqa: E501
                taxable=False,
            ...
            get_tx_event_type_identifier(HistoryEventType.WITHDRAWAL, HistoryEventSubType.BRIDGE, CPT_ARBITRUM_ONE): TxEventSettings(  # noqa: E501
                taxable=False,
                count_entire_amount_spend=False,
                count_cost_basis_pnl=True,
                method='acquisition',
