...
class LidoCsmMetricsFetcher:
    ...
    def get_operator_stats(self, node_operator_id: int) -> LidoCsmNodeOperatorStats:
        ...
        try:
            ...
            operator_type = None
        operator_type_id = int(operator_type) if operator_type is not None else None
        operator_label = operator_type.label if operator_type is not None else 'Unknown'
