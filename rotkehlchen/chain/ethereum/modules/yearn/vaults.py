    ...
    def __init__(
        ...
        self.yearn_vaults = {
            'yyDAI+yUSDC+yUSDT+yTUSD': YearnVault(
                name='YCRV Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x5dbcF33D8c2E976c6b560249878e6F1491Bca25c')),  # noqa: E501
                underlying_token=A_CRVP_DAIUSDCTTUSD.resolve_to_evm_token(),
                token=A_YV1_DAIUSDCTTUSD.resolve_to_evm_token(),
            ),
            'yDAI': YearnVault(
                name='YDAI Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xACd43E627e64355f1861cEC6d3a6688B31a6F952')),  # noqa: E501
                underlying_token=A_DAI.resolve_to_evm_token(),
                token=A_YV1_DAI.resolve_to_evm_token(),
            ),
            'yWETH': YearnVault(
                name='YWETH Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xe1237aA7f535b0CC33Fd973D66cBf830354D16c7')),  # noqa: E501
                underlying_token=A_WETH.resolve_to_evm_token(),
                token=A_YV1_WETH.resolve_to_evm_token(),
            ),
            'yYFI': YearnVault(
                name='YYFI Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xBA2E7Fed597fd0E3e70f5130BcDbbFE06bB94fe1')),  # noqa: E501
                underlying_token=A_YFI.resolve_to_evm_token(),
                token=A_YV1_YFI.resolve_to_evm_token(),
            ),
            'yaLINK': YearnVault(
                name='YALINK Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x29E240CFD7946BA20895a7a02eDb25C210f9f324')),  # noqa: E501
                underlying_token=A_ALINK_V1.resolve_to_evm_token(),
                token=A_YV1_ALINK.resolve_to_evm_token(),
            ),
            'yUSDT': YearnVault(
                name='YUSDT Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x2f08119C6f07c006695E079AAFc638b8789FAf18')),  # noqa: E501
                underlying_token=A_USDT.resolve_to_evm_token(),
                token=A_YV1_USDT.resolve_to_evm_token(),
            ),
            'yUSDC': YearnVault(
                name='YUSDC Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x597aD1e0c13Bfe8025993D9e79C69E1c0233522e')),  # noqa: E501
                underlying_token=A_USDC.resolve_to_evm_token(),
                token=A_YV1_USDC.resolve_to_evm_token(),
            ),
            'yTUSD': YearnVault(
                name='YTUSD Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x37d19d1c4E1fa9DC47bD1eA12f742a0887eDa74a')),  # noqa: E501
                underlying_token=A_TUSD.resolve_to_evm_token(),
                token=A_YV1_TUSD.resolve_to_evm_token(),
            ),
            'yGUSD': YearnVault(
                name='GUSD Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xec0d8D3ED5477106c6D4ea27D90a60e594693C90')),  # noqa: E501
                underlying_token=A_GUSD.resolve_to_evm_token(),
                token=A_YV1_GUSD.resolve_to_evm_token(),
            ),
            'yyDAI+yUSDC+yUSDT+yBUSD': YearnVault(
                name='YBCURVE Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x2994529C0652D127b7842094103715ec5299bBed')),  # noqa: E501
            ...
            'ycrvRenWSBTC': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x7Ff566E1d69DEfF32a7b244aE7276b9f90e9D0f6')),  # noqa: E501
                underlying_token=A_CRVP_RENWSBTC.resolve_to_evm_token(),
                token=A_YV1_RENWSBTC.resolve_to_evm_token(),
            ),
            'y3Crv': YearnVault(
                name='Y3CRV Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x9cA85572E6A3EbF24dEDd195623F188735A5179f')),  # noqa: E501
            ...
            'pSLP': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xbD17B1ce622d73bD438b9E658acA5996dc394b0d')),  # noqa: E501
            ...
            'yvcDAI+cUSDC': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x629c759D1E83eFbF63d84eb3868B564d9521C129')),  # noqa: E501
            ...
            'yvmusd3CRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x0FCDAeDFb8A7DfDa2e9838564c5A1665d856AFDF')),  # noqa: E501
            ...
            'yvgusd3CRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xcC7E70A958917cCe67B4B87a8C30E6297451aE98')),  # noqa: E501
            ...
            'yveursCRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x98B058b2CBacF5E99bC7012DF757ea7CFEbd35BC')),  # noqa: E501
                underlying_token=CRV_EURS.resolve_to_evm_token(),
                token=A_YV1_EURS_CRV.resolve_to_evm_token(),
            ),
            'yvmUSD': YearnVault(
                name='mUSD Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xE0db48B4F71752C4bEf16De1DBD042B82976b8C7')),  # noqa: E501
            ...
            'yvcrvRenWBTC': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x5334e150B938dd2b6bd040D9c4a03Cff0cED3765')),  # noqa: E501
            ...
            'yvusdn3CRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xFe39Ce91437C76178665D64d7a2694B0f6f17fE3')),  # noqa: E501
            ...
            'yvust3CRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xF6C9E9AF314982A4b38366f4AbfAa00595C5A6fC')),  # noqa: E501
            ...
            'yvbBTC/sbtcCRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xA8B1Cb4ed612ee179BDeA16CCa6Ba596321AE52D')),  # noqa: E501
            ...
            'yvtbtc/sbtcCrv': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x07FB4756f67bD46B748b16119E802F1f880fb2CC')),  # noqa: E501
            ...
            'yvoBTC/sbtcCRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x7F83935EcFe4729c4Ea592Ab2bC1A32588409797')),  # noqa: E501
                underlying_token=CRV_OBTC_SBTC.resolve_to_evm_token(),
                token=A_YV1_OBTC_CRV.resolve_to_evm_token(),
            ),
            'yvhCRV': YearnVault(
                name='curve.fi/hbtc Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x46AFc2dfBd1ea0c0760CAD8262A5838e803A37e5')),  # noqa: E501
            ...
            'yvcrvPlain3andSUSD': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x5533ed0a3b83F70c3c4a1f69Ef5546D3D4713E44')),  # noqa: E501
            ...
            'yvhusd3CRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x39546945695DCb1c037C836925B355262f551f55')),  # noqa: E501
            ...
            'yvdusd3CRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x8e6741b456a074F0Bc45B8b82A755d4aF7E965dF')),  # noqa: E501
                underlying_token=CRV_DUSD.resolve_to_evm_token(),
                token=A_YV1_DUSD_3CRV.resolve_to_evm_token(),
            ),
            'yva3CRV': YearnVault(
                name='curve.fi/aave Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x03403154afc09Ce8e44C3B185C82C6aD5f86b9ab')),  # noqa: E501
                underlying_token=A_CRV_3CRV.resolve_to_evm_token(),
                token=A_YV1_A3CRV.resolve_to_evm_token(),
            ),
            'yvankrCRV': YearnVault(
                name='curve.fi/ankreth Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xE625F5923303f1CE7A43ACFEFd11fd12f30DbcA4')),  # noqa: E501
                underlying_token=CRV_AETH.resolve_to_evm_token(),
                token=A_YV1_ETH_ANKER.resolve_to_evm_token(),
            ),
            'yvsaCRV': YearnVault(
                name='curve.fi/saave Vault',
                contract=self.ethereum.contracts.contract(string_to_evm_address('0xBacB69571323575C6a5A3b4F9EEde1DC7D31FBc1')),  # noqa: E501
            ...
            'yvusdp3CRV': YearnVault(
                ...
                contract=self.ethereum.contracts.contract(string_to_evm_address('0x1B5eb1173D2Bf770e50F10410C9a96F7a8eB6e75')),  # noqa: E501
