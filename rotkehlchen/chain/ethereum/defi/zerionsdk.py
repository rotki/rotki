...
def _handle_pooltogether_v3(normalized_balance: FVal, token_name: str) -> Optional[DefiBalance]:
    ...
    if 'COMP' in token_name:
        ...
        return DefiBalance(
            token_address=to_checksum_address('0x27B85f596feB14e4B5fAA9671720a556a7608C69'),
    ...
    if 'DAI' in token_name:
        dai_price = Inquirer.find_usd_price(A_DAI)
        return DefiBalance(
            token_address=to_checksum_address('0x334cBb5858417Aee161B53Ee0D5349cCF54514CF'),
    ...
    if 'USDC' in token_name:
        usdc_price = Inquirer.find_usd_price(A_USDC)
        return DefiBalance(
            token_address=to_checksum_address('0xD81b1A8B1AD00Baa2D6609E0BAE28A38713872f7'),
