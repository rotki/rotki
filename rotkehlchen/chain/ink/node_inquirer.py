...
class InkInquirer(EvmNodeInquirer):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            contracts=(contracts := EvmContracts[Literal[ChainID.INK]](chain_id=ChainID.INK)),
            rpc_timeout=rpc_timeout,
            contract_multicall=contracts.contract(INK_MULTICALL_ADDRESS),
