...
class InkTransactionDecoder(L2WithL1FeesTransactionDecoder):

    def __init__(
            self,
            database: DBHandler,
            ink_inquirer: InkInquirer,
            transactions: InkTransactions,
            premium: Premium | None = None,
            monerium: Monerium | None = None,
    ):
        super().__init__(
            database=database,
            node_inquirer=ink_inquirer,
        ...
        self.evm_inquirer: InkInquirer  # re-affirm type
