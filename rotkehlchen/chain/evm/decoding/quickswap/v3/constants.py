...
QUICKSWAP_V3_NFT_MANAGER_ABI: Final[ABI] = [{'inputs': [{'name': 'tokenId', 'type': 'uint256'}], 'name': 'positions', 'outputs': [{'name': 'nonce', 'type': 'uint96'}, {'name': 'operator', 'type': 'address'}, {'name': 'token0', 'type': 'address'}, {'name': 'token1', 'type': 'address'}, {'name': 'tickLower', 'type': 'int24'}, {'name': 'tickUpper', 'type': 'int24'}, {'name': 'liquidity', 'type': 'uint128'}, {'name': 'feeGrowthInside0LastX128', 'type': 'uint256'}, {'name': 'feeGrowthInside1LastX128', 'type': 'uint256'}, {'name': 'tokensOwed0', 'type': 'uint128'}, {'name': 'tokensOwed1', 'type': 'uint128'}], 'stateMutability': 'view', 'type': 'function'}]  # noqa: E501
QUICKSWAP_V3_POOL_ABI: Final[ABI] = [{'inputs': [], 'name': 'globalState', 'outputs': [{'name': 'price', 'type': 'uint160'}, {'name': 'tick', 'type': 'int24'}, {'name': 'fee', 'type': 'uint16'}, {'name': 'timepointIndex', 'type': 'uint16'}, {'name': 'communityFeeToken0', 'type': 'uint8'}, {'name': 'communityFeeToken1', 'type': 'uint8'}, {'name': 'unlocked', 'type': 'bool'}], 'stateMutability': 'view', 'type': 'function'}]  # noqa: E501
QUICKSWAP_V3_POOL_INIT_CODE_HASH: Final = '6ec6c9c8091d160c0aa74b2b14ba9c1717e95093bd3ac085cee99a49aab294a4'  # noqa: E501
