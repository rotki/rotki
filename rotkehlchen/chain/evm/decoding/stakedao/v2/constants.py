...
LAPOSTE_MESSAGE_ABI: Final = '(uint256,address,address,(address,uint256)[],(string,string,uint8)[],bytes,uint256)'  # (destinationChainId, to, sender, tokens[], tokenMetadata[], payload, nonce)  # noqa: E501
