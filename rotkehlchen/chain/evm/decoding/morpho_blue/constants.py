...
MORPHO_BLUE_ADDRESSES: Final = {
    ChainID.ARBITRUM_ONE: string_to_evm_address('0x6c247b1F6182318877311737BaC0844bAa518F5e'),
    ChainID.BASE: MORPHO_BLUE,
    ChainID.ETHEREUM: MORPHO_BLUE,
    ChainID.HYPERLIQUID: string_to_evm_address('0x68e37dE8d93d3496ae143F2E900490f6280C57cD'),
    ChainID.MONAD: string_to_evm_address('0xD5D960E8C380B724a48AC59E2DfF1b2CB4a1eAee'),
    ChainID.OPTIMISM: string_to_evm_address('0xce95AfbB8EA029495c66020883F87aaE8864AF92'),
}
