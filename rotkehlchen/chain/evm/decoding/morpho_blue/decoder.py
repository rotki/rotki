...
class MorphoBlueDecoder(EvmDecoderInterface):
    ...
    def __init__(self, *args: Any) -> None:
        super().__init__(*args)
        self.morpho_blue = MORPHO_BLUE_ADDRESSES[self.node_inquirer.chain_id]
        ...
        for event in context.decoded_events:
            if (
                ...
                if (
                        ...
                        context.transaction.to_address is not None and
                        context.transaction.to_address != self.morpho_blue and
            ...
            if later_transfer_sender is not None:
                return EvmDecodingOutput(action_items=[ActionItem(
                    ...
                    to_counterparty=CPT_MORPHO_BLUE,
                    to_address=to_address or self.morpho_blue,
                    extra_data={'market_id': bytes_to_hexstr(context.tx_log.topics[1])},
                )])
    ...
    def _maybe_get_later_morpho_transfer_sender(
        ...
        for tx_log in context.all_logs:
            ...
            if (
                    ...
                    bytes_to_address(tx_log.topics[2]) == self.morpho_blue and
    ...
    def addresses_to_decoders(self) -> dict[ChecksumEvmAddress, tuple[Any, ...]]:
        return {self.morpho_blue: (self._decode_morpho_blue_event,)}
    ...
    def addresses_to_counterparties(self) -> dict[ChecksumEvmAddress, str]:
        return {self.morpho_blue: CPT_MORPHO_BLUE}
