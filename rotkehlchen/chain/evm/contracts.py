...
class EvmContracts(Generic[T]):
    ...
    @overload
    def abi(self: 'EvmContracts[Literal[ChainID.POLYGON_POS, ChainID.ARBITRUM_ONE, ChainID.BASE, ChainID.GNOSIS, ChainID.SCROLL, ChainID.BINANCE_SC, ChainID.MONAD]]', name: Literal['']) -> ABI:  # noqa: E501
        ...
