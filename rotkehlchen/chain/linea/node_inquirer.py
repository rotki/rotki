...
class LineaInquirer(EvmNodeInquirer):
    ...
    def __init__(
        ...
        contracts = EvmContracts[Literal[ChainID.LINEA]](chain_id=ChainID.LINEA)
        super().__init__(
            ...
            blockscout=blockscout,
            routescan=routescan,
            blockchain=SupportedBlockchain.LINEA,
            contracts=contracts,
            rpc_timeout=rpc_timeout,
            contract_multicall=contracts.contract(LINEA_MULTICALL_ADDRESS),
