...
from rotkehlchen.chain.evm.decoding.velodrome.constants import SLIPSTREAM_NFPM_ADDRESSES
...
SLIPSTREAM_NFPM: Final = SLIPSTREAM_NFPM_ADDRESSES[ChainID.OPTIMISM]
