...
# Created at 2026-07-28 09:52:07 UTC with rotki version 1.43.3.dev658+gb5257f2db5.d20260728 by Codex
MINIMIZED_GLOBAL_DB_SCHEMA = {
    ...
    "asset_flags": "identifiertextnotnullcollatenocase,flagtextnotnull,primarykey(identifier,flag),foreignkey(identifier)referencesassets(identifier)onupdatecascadeondeletecascade",
    ...
    "binance_pairs": "pairtextnotnull,base_assettextnotnull,quote_assettextnotnull,connectortextnotnull,foreignkey(base_asset)referencesassets(identifier)onupdatecascadeondeletecascade,foreignkey(quote_asset)referencesassets(identifier)onupdatecascadeondeletecascade,primarykey(pair,connector)",
    ...
    "connector_asset_mappings": "connectortext,exchange_symboltextnotnull,local_idtextnotnullcollatenocase,unique(connector,exchange_symbol)",
    ...
    "hyperliquid_tokens": "identifiertextprimarykeynotnullcollatenocase,addressvarchar[34]notnull,decimalsinteger,foreignkey(identifier)referencesassets(identifier)onupdatecascadeondeletecascade",
}
...
MINIMIZED_GLOBAL_DB_INDEXES = {
    ...
    "idx_price_history_pair_timestamp": "createindexifnotexistsidx_price_history_pair_timestamponprice_history(from_asset,to_asset,timestamp,source_type)",
    ...
    "idx_connector_mappings_identifier": "createindexifnotexistsidx_connector_mappings_identifieronconnector_asset_mappings(local_id)",
    ...
    "idx_hyperliquid_tokens_identifier": "createindexifnotexistsidx_hyperliquid_tokens_identifieronhyperliquid_tokens(identifier,address)",
}
