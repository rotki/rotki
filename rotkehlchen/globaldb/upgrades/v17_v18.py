...
def migrate_to_v18(
    ...
    """Add Coinbase as a historical price source."""

    @progress_step('Adding Coinbase to price_history_source_types')
    def _add_coinbase_price_source(write_cursor: DBCursor) -> None:
