...
HistoricalPriceOracleInstance = Union['Coingecko', 'Cryptocompare', 'Defillama', 'Alchemy', 'GoldRush', 'UniswapV2Oracle', 'UniswapV3Oracle']  # noqa: E501
...
DEFAULT_HISTORICAL_PRICE_ORACLES_ORDER = (
    ...
    HistoricalPriceOracle.GOLDRUSH,
)
