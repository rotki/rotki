...
class SwapEvent(HistoryBaseEntry):
    ...
    def __init__(
        ...
        `fee_index`: Index of the fee event for multi-fee swaps. Only has an effect if the
            event_subtype is HistoryEventSubType.FEE.
        """
        super().__init__(
            ...
            sequence_index={
                ...
                HistoryEventSubType.FEE: 2 + fee_index,
            }[event_subtype],
            timestamp=timestamp,
            location=location,
...
def create_swap_events_multi_fee(
    ...
    fee_index = 0  # use counter instead of enumerate to keep indexes consecutive if there are skipped zero value fees  # noqa: E501
