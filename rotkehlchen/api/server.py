...
URLS_V1: URLS = [
    ...
    ('/blockchains/<string:blockchain>/defi', DefiBalancesResource),
    ('/blockchains/<string:blockchain>/erc20details', ERC20TokenInfo),
    ...
    ('/blockchains/<string:blockchain>/transactions', EvmTransactionsResource),
    (
        '/blockchains/<string:blockchain>/transactions/<string:address>',
        EvmTransactionsResource,
        'per_address_ethereum_transactions_resource',  # TODO: Evm
