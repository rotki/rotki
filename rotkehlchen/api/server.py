...
from rotkehlchen.api.v1.resources import (
    ...
    AssociatedLocations,
    AsyncTasksResource,
    BankAuthenticationResource,
    BankBalancesResource,
    BanksResource,
    BankSyncResource,
    ...
    HistoricalBalancesAtEventsResource,
    ...
    LocationAliasesResource,
    LocationImageResource,
    LocationLabelsResource,
    LocationResource,
    LocationsTreeResource,
    LocationUsageResource,
    ...
    SupportedBanksResource,
    SupportedChainsResource,
    SupportedExchangesResource,
    TagsResource,
...
URLS_V1: URLS = [
    ...
    ('/settings/frontend', FrontendSettingsResource),
    ...
    ('/banks', BanksResource),
    ('/banks/auth', BankAuthenticationResource),
    ('/banks/supported', SupportedBanksResource),
    ('/exchanges/supported', SupportedExchangesResource),
    ('/banks/sync', BankSyncResource),
    ('/banks/balances', BankBalancesResource),
    ('/banks/balances/<string:location>', BankBalancesResource, 'named_bank_balances_resource'),
    ...
    ('/assets/connectormappings', ConnectorAssetMappingsResource),
    ...
    ('/exchanges/binance/pairs/<string:identifier>', BinanceUserMarkets),
    ...
    ('/import/preflight', DataImportPreflightResource),
    ('/nfts', NFTSResource),
    ...
    ('/locations', LocationsTreeResource),
    ('/locations/aliases', LocationAliasesResource),
    ('/locations/all', LocationResource),
    ('/locations/associated', AssociatedLocations),
    ('/locations/labels', LocationLabelsResource),
    ('/locations/<string:identifier>', CustomLocationResource),
    ('/locations/<string:identifier>/usage', LocationUsageResource),
    ('/locations/<string:identifier>/image', LocationImageResource),
    ...
    ('/balances/historical/events', HistoricalBalancesAtEventsResource),
