...
class UserCredentials(BaseModel):
    ...
    initial_settings: ModifiableDBSettings | None = Field(default=None, description='Initial settings')
    premium_api_key: str | None = Field(default=None, description='Premium API key')
    premium_api_secret: str | None = Field(default=None, description='Premium API secret')
