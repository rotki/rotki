...
from rotkehlchen.errors.misc import AuthenticationError, SystemPermissionError
...
class AsyncAuthManager:
    ...
    async def get_session(self, token: str) -> Optional[AsyncSession]:
...
__all__ = ['router', 'AsyncAuthManager', 'require_logged_in_user']