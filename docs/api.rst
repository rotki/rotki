...
.. http:get:: /api/(version)/blockchains/ETH/modules/balancer/history/events
   ...
   **Example Response**:
...

      {
          ...
          "result": {
              "0x7716a99194d758c8537F056825b75Dd0C8FDD89f": [
                  {
                      "address": "0x7716a99194d758c8537F056825b75Dd0C8FDD89f",
                      ...
                      "events": [
                        ...
                        },
                        {
                          ...
                          "amounts": ["0.010687148200906598", "0.744372160905819159"]
                        }
                      ],
                      "profit_loss_amounts": ["-0.039312851799093402", "0.744372160905819159"],
   ...
   :resjson list[object] events: A list of all the events generated by the address interacting with the pool.
       ...
       - timestamp: The Unix epoch point in UTC time when the event happened (in seconds).
       - event_type: The type of interaction, i.e. "mint" (add liquidity) and "burn" (remove liquidity).
       - amounts: A list where each item is the amount added or removed of the pool token at the same index (from the "pool_tokens" list).
   ...
   :resjson list[string] profit_loss_amounts: Each item is the profit/loss amount of the pool token at the same index (from the "pool_tokens" list).
