...
.. http:put:: /api/(version)/lido-csm/node-operators
   ...
   Add a new tracked Lido CSM node operator. The backend persists the association and attempts to compute metrics immediately.
   ...
   **Example Request**:
   ...
   :reqjson string address: Checksummed Ethereum address that owns the node operator.
