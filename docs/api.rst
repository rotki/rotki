...
.. http:post:: /api/(version)/history/events
   ...
   **Example Response**:
   ...
   :resjson string user_notes: Common key. Custom notes for the event set by the user.
   :resjson string auto_notes: Common key. Autogenerated string description of the event.
