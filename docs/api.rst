...
.. http:get:: /api/(version)/blockchains/eth/modules/uniswap/v2/balances
   ...
   **Example Response**:
   ...
   :resjson object user_balance: The liquidity token user balance and its value in the user's preferred currency.
