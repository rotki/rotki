...
Start with the release of v1.6.2, rotki releases now include the sha512 sum of the packaged binaries.
...
To verify that the generate hash matches you need to open the ``rotki-win32-vx.x.x.exe.sha512`` with ``Notepad`` or
