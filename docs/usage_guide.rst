...
For Bitcoin you can add addresses manually or let rotki discover them using a xpub. From this key rotki can generate your addresses and can query the Bitcoin's blockchain for each one of them until it finds unused addresses.
xpub also generates different types of addresses, P2PKH's addresses have "1" as prefix, P2SH_P2wPKH's addresses start with a "3" and addresses generated by WPKH start with "bc1". 
This key does not allow spending your coins but provides information about your wallet, in rotki all this information is encrypted and safe.
