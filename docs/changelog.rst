...
* :bug:`-` Automatically removing a calendar entry, like an airdrop claim deadline after the airdrop is claimed, no longer also deletes the reminder of an unrelated calendar entry. Calendar entries with reminders are also created for the cliff and full vesting dates of your escrows.
