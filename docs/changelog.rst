...
* :feature:`1618` Balancer protocol is now supported for Premium users. Users can see their LP balances and swaps history. Finally the balancer trades are now taken into account in the profit/loss report.
