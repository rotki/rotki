...
* :feature:`7349` Improved CSV import error reporting. Rotki now provides feedback on import results, including the number of successfully imported entries and specific error messages for failed imports.
