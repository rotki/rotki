...
This is the documentation for the |version| version of the `Rotkehlchen <http://rotkehlchen.io/>`_. The sourcecode along with the issue tracker is in the `Github Repository <https://github.com/rotkehlchenio/rotkehlchen>`_.
...
If this is the first time looking at Rotkehlchen you will probably want to visit the :doc:`Installation Guide<installation_guide>`. Once you have succesfully managed to install Rotkehlchen you can proceed to the :doc:`Usage Guide<usage_guide>`.
