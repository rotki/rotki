...
if os.name == 'nt':
    ...
    # OSError: cannot load library 'C:\Users\lefteris\AppData\Local\Temp\_MEI50802\coincurve\libsecp256k1.dll': error 0x7e.  Additionally, ctypes.util.find_library()did not manage to locate a library called 'C:\\Users\\lefteris\\AppData\\Local\\Temp\\_MEI50802\\coincurve\\libsecp256k1.dll'
